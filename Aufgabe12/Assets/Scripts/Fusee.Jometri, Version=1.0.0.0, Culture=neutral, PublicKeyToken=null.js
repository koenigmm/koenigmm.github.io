...
(function BinarySearchTree$b2$Members () {
  ...
  function BinarySearchTree$b2_BalanceTree$00 () {
    var inorder = $T00().ToArray$b1($asm06.Fusee.Jometri.Node$b2.Of($thisType.TK.get(this), $thisType.TV.get(this)))($thisType.Of($thisType.TK.get(this), $thisType.TV.get(this)).InOrderTraverseTree(this._globalRoot));
    this._globalRoot = $thisType.Of($thisType.TK.get(this), $thisType.TV.get(this)).BalanceTree($asm0E.System.Collections.Generic.IList$b1.Of($asm06.Fusee.Jometri.Node$b2.Of($thisType.TK.get(this), $thisType.TV.get(this))).$Cast(inorder), 0, (((inorder.length | 0) - 1) | 0));
  }; 

  function BinarySearchTree$b2_BalanceTree$01 (inorder, startIndex, endIndex) {
    var $im00 = $asm0E.System.Collections.Generic.IList$b1.Of($asm06.Fusee.Jometri.Node$b2.Of($thisType.TK.get(this), $thisType.TV.get(this))).get_Item;
    if ((startIndex | 0) > (endIndex | 0)) {
      var result = null;
    } else {
      var middIndex = (((((startIndex | 0) + (endIndex | 0)) | 0) / 2) | 0);
      var root = new ($asm06.Fusee.Jometri.Node$b2.Of($thisType.TK.get(this), $thisType.TV.get(this))) (JSIL.CloneParameter($thisType.TK.get(this), $im00.Call(inorder, null, middIndex).Node$b2$Key$value), JSIL.CloneParameter($thisType.TV.get(this), $im00.Call(inorder, null, middIndex).Node$b2$Value$value));
  ...
  JSIL.MakeType({
    ...
    $.Method({Static:true , Public:false}, "BalanceTree", 
      new JSIL.MethodSignature($asm06.TypeRef("Fusee.Jometri.Node`2", [$.GenericParameter("TK"), $.GenericParameter("TV")]), [
          $asm0E.TypeRef("System.Collections.Generic.IList`1", [$asm06.TypeRef("Fusee.Jometri.Node`2", [$.GenericParameter("TK"), $.GenericParameter("TV")])]), $.Int32, 
          $.Int32
        ]), 
    ...
    $.Method({Static:true , Public:false}, "InOrderTraverseTree", 
      new JSIL.MethodSignature($asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.Node`2", [$.GenericParameter("TK"), $.GenericParameter("TV")])]), [$asm06.TypeRef("Fusee.Jometri.Node`2", [$.GenericParameter("TK"), $.GenericParameter("TV")])]), 
    ...
    $.Method({Static:false, Public:false}, "PreorderTraverseTreeNodes", 
      new JSIL.MethodSignature($asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.Node`2", [$.GenericParameter("TK"), $.GenericParameter("TV")])]), null), 
...
(function $lPreorderTraverseTreeKeys$gd__3$Members () {
  ...
  function $lPreorderTraverseTreeKeys$gd__3_MoveNext ($exception) {
    var $im00 = $asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm06.Fusee.Jometri.Node$b2.Of($thisType.TK.get(this), $thisType.TV.get(this))).GetEnumerator;
    var $im01 = $asm0E.System.Collections.Generic.IEnumerator$b1.Of($asm06.Fusee.Jometri.Node$b2.Of($thisType.TK.get(this), $thisType.TV.get(this))).get_Current;
    try {
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:false}, "$l$gs__1", $asm0E.TypeRef("System.Collections.Generic.IEnumerator`1", [$asm06.TypeRef("Fusee.Jometri.Node`2", [$.GenericParameter("TK"), $.GenericParameter("TV")])]));
...
(function $lPreorderTraverseTreeValues$gd__4$Members () {
  ...
  function $lPreorderTraverseTreeValues$gd__4_MoveNext ($exception) {
    try {
      ...
      if (num !== 0) {
        ...
        this.$l$gs__2 = $asm0E.System.Collections.Generic.List$b1.Of($asm06.Fusee.Jometri.Node$b2.Of($thisType.TK.get(this), $thisType.TV.get(this))).prototype.GetEnumerator.call(this.$ltraverseGlobal$g5__1);
        this.$l$g1__state = -3;
      }
      if (!$asm0E.System.Collections.Generic.List$b1_Enumerator.Of($asm06.Fusee.Jometri.Node$b2.Of($thisType.TK.get(this), $thisType.TV.get(this))).prototype.MoveNext.call(this.$l$gs__2)) {
        this.$l$gm__Finally1();
        this.$l$gs__2 = new ($asm0E.System.Collections.Generic.List$b1_Enumerator.Of($asm06.Fusee.Jometri.Node$b2.Of($thisType.TK.get(this), $thisType.TV.get(this)))) ();
        result = false;
      } else {
        this.$lnode$g5__3 = $asm0E.System.Collections.Generic.List$b1_Enumerator.Of($asm06.Fusee.Jometri.Node$b2.Of($thisType.TK.get(this), $thisType.TV.get(this))).prototype.get_Current.call(this.$l$gs__2);
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:false}, "$ltraverseGlobal$g5__1", $asm0E.TypeRef("System.Collections.Generic.List`1", [$asm06.TypeRef("Fusee.Jometri.Node`2", [$.GenericParameter("TK"), $.GenericParameter("TV")])]));

    $.Field({Static:false, Public:false}, "$l$gs__2", $asm0E.TypeRef("System.Collections.Generic.List`1+Enumerator", [$asm06.TypeRef("Fusee.Jometri.Node`2", [$.GenericParameter("TK"), $.GenericParameter("TV")])]));
...
(function $lPreorderTraverseTreeNodes$gd__5$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Method({Static:false, Public:false, Virtual:true }, "System.Collections.Generic.IEnumerable$lFusee.Jometri.Node$lTK$cmTV$g$g.GetEnumerator", 
      new JSIL.MethodSignature($asm0E.TypeRef("System.Collections.Generic.IEnumerator`1", [$asm06.TypeRef("Fusee.Jometri.Node`2", [$.GenericParameter("TK"), $.GenericParameter("TV")])]), null), 
      $lPreorderTraverseTreeNodes$gd__5_System_Collections_Generic_IEnumerable$lFusee_Jometri_Node$lTK$cmTV$g$g_GetEnumerator
    )
      .Overrides($asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.Node`2", [$.GenericParameter("TK"), $.GenericParameter("TV")])]), "GetEnumerator")
      .Attribute($asm0E.TypeRef("System.Diagnostics.DebuggerHiddenAttribute"));
    ...
    $.Method({Static:false, Public:false, Virtual:true }, "System.Collections.Generic.IEnumerator$lFusee.Jometri.Node$lTK$cmTV$g$g.get_Current", 
      ...
      .Overrides($asm0E.TypeRef("System.Collections.Generic.IEnumerator`1", [$asm06.TypeRef("Fusee.Jometri.Node`2", [$.GenericParameter("TK"), $.GenericParameter("TV")])]), "get_Current")
      .Attribute($asm0E.TypeRef("System.Diagnostics.DebuggerHiddenAttribute"));
    ...
    $.ImplementInterfaces(
      /* 0 */ $asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.Node`2", [$.GenericParameter("TK"), $.GenericParameter("TV")])]), 
      /* 1 */ $asm0E.TypeRef("System.Collections.IEnumerable"), 
      /* 2 */ $asm0E.TypeRef("System.Collections.Generic.IEnumerator`1", [$asm06.TypeRef("Fusee.Jometri.Node`2", [$.GenericParameter("TK"), $.GenericParameter("TV")])]), 
      /* 3 */ $asm0E.TypeRef("System.Collections.IEnumerator"), 
      /* 4 */ $asm0E.TypeRef("System.IDisposable")
    );
...
(function $lPreorderTraverseTree$gd__6$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:false}, "$l$gs__3", $asm0E.TypeRef("System.Collections.Generic.IEnumerator`1", [$asm06.TypeRef("Fusee.Jometri.Node`2", [$.GenericParameter("TK"), $.GenericParameter("TV")])]));
...
(function GeometricOperations$Members () {
  var $, $thisType;
  var $T00 = function () {
    return ($T00 = JSIL.Memoize($asm0E.System.Collections.Generic.IList$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex))) ();
  };
  var $T01 = function () {
  ...
  var $T03 = function () {
    return ($T03 = JSIL.Memoize($asm0E.System.Collections.Generic.ICollection$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex))) ();
  };
  var $T04 = function () {
    return ($T04 = JSIL.Memoize($asm06.Fusee.Jometri.DCEL.Geometry)) ();
  };
  var $T05 = function () {
    return ($T05 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge))) ();
  };
  var $T06 = function () {
  ...
  var $T0A = function () {
    return ($T0A = JSIL.Memoize($asm0E.System.Math)) ();
  };
  var $T0B = function () {
  ...
  var $T0D = function () {
    return ($T0D = JSIL.Memoize($asm0E.System.Collections.Generic.IList$b1.Of($asm07.Fusee.Math.Core.float3))) ();
  };
  var $T0E = function () {
    return ($T0E = JSIL.Memoize($asm0E.System.Collections.Generic.ICollection$b1.Of($asm07.Fusee.Math.Core.float3))) ();
  };
  var $T0F = function () {
    return ($T0F = JSIL.Memoize($asm0E.System.Collections.Generic.List$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex))) ();
  };
  var $T10 = function () {
  ...
  var $T14 = function () {
    return ($T14 = JSIL.Memoize($asm0E.System.Decimal)) ();
  };
  var $S00 = function () {
    return ($S00 = JSIL.Memoize(new JSIL.MethodSignature($asm07.Fusee.Math.Core.float3, [$asm07.Fusee.Math.Core.float3, $asm0E.System.Single]))) ();
  };
  var $S01 = function () {
    return ($S01 = JSIL.Memoize(new JSIL.MethodSignature($asm07.Fusee.Math.Core.float3, [$asm07.Fusee.Math.Core.float3, $asm07.Fusee.Math.Core.float3x3]))) ();
  };
  var $S02 = function () {
    return ($S02 = JSIL.Memoize(new JSIL.MethodSignature($asm07.Fusee.Math.Core.float3, [$asm07.Fusee.Math.Core.float3x3, $asm07.Fusee.Math.Core.float3]))) ();
  };
  var $S03 = function () {
    return ($S03 = JSIL.Memoize(new JSIL.MethodSignature($asm0E.System.Decimal, [$asm0E.System.Decimal, $asm0E.System.Int32]))) ();
  };
  var $S04 = function () {
    return ($S04 = JSIL.Memoize(new JSIL.MethodSignature($asm0E.System.Decimal, [$asm0E.System.Single]))) ();
  };
  var $S05 = function () {
    return ($S05 = JSIL.Memoize(new JSIL.MethodSignature($asm0E.System.Single, [$asm0E.System.Decimal]))) ();
  };
  var $IM00 = function () {
    return ($IM00 = JSIL.Memoize($asm0E.System.Collections.Generic.ICollection$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex).get_Count)) ();
  };
  var $IM01 = function () {
    return ($IM01 = JSIL.Memoize($asm0E.System.Collections.Generic.IList$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex).get_Item)) ();
  };
  var $IM02 = function () {
    return ($IM02 = JSIL.Memoize($asm0E.System.Collections.Generic.ICollection$b1.Of($asm07.Fusee.Math.Core.float3).get_Count)) ();
  };
  var $IM03 = function () {
  ...
  function GeometricOperations_IsPointInPolygon$00 (geometry, face, v) {
    ...
    var v2 = geometry.GetVertexByHandle($T11().LastItem$b1($T08())(faceVerts).Handle).MemberwiseClone();
  ...
  function GeometricOperations_Reduce2D (vertPos, normal) {
    var rot = new ($T13())(), row = new ($T01())(), row2 = new ($T01())(), row3 = new ($T01())(), changeOfBasisMat = new ($T13())(), transposeMat = new ($T13())();
    normal.Normalize();
    var flag = $T01().op_Equality(normal.MemberwiseClone(), $T01().UnitZ.MemberwiseClone());
    if (flag) {
      (rot = rot.MemberwiseClone(), 
        $T13().prototype._ctor.call(rot, 
          -1, 
          0, 
          0, 
          0, 
      ...
      var result = $S01().CallStatic($T13(), "op_Multiply", null, vertPos, rot);
    } else {
      ...
      if (flag2) {
        ...
        (changeOfBasisMat = changeOfBasisMat.MemberwiseClone(), 
          $T13().prototype._ctor.call(changeOfBasisMat, row.MemberwiseClone(), row2.MemberwiseClone(), row3.MemberwiseClone()));
        (transposeMat = transposeMat.MemberwiseClone(), 
          $T13().prototype._ctor.call(transposeMat, changeOfBasisMat.Row0.MemberwiseClone(), changeOfBasisMat.Row1.MemberwiseClone(), changeOfBasisMat.Row2.MemberwiseClone()));
        transposeMat.Transpose();
        var newVert = $S02().CallStatic($T13(), "op_Multiply", null, transposeMat, vertPos);
        var vecX = $S03().CallStatic($T0A(), "Round", null, $S04().CallStatic($T14(), "op_Explicit", null, newVert.x), 5);
        var vecY = $S03().CallStatic($T0A(), "Round", null, $S04().CallStatic($T14(), "op_Explicit", null, newVert.y), 5);
        var vecZ = $S03().CallStatic($T0A(), "Round", null, $S04().CallStatic($T14(), "op_Explicit", null, newVert.z), 5);
        (newVert = newVert.MemberwiseClone(), 
          $T01().prototype._ctor.call(newVert, 
            $S05().CallStatic($T14(), "op_Explicit", null, vecX), 
            $S05().CallStatic($T14(), "op_Explicit", null, vecY), 
            $S05().CallStatic($T14(), "op_Explicit", null, vecZ)
          ));
        result = newVert;
      }
    }
  ...
  JSIL.MakeStaticClass("Fusee.Jometri.GeometricOperations", true, [], function ($ib) {
    ...
    $.Method({Static:true , Public:true }, "CalculateFaceNormal", 
      new JSIL.MethodSignature($asm07.TypeRef("Fusee.Math.Core.float3"), [$asm0E.TypeRef("System.Collections.Generic.IList`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")])]), 
      GeometricOperations_CalculateFaceNormal
    );

    $.Method({Static:true , Public:true }, "GetHalfEdgesWChangedWinding", 
      new JSIL.MethodSignature($asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")]), [$asm06.TypeRef("Fusee.Jometri.DCEL.Geometry"), $asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")])]), 
    ...
    $.Method({Static:true , Public:true }, "IsCounterClockwise", 
      new JSIL.MethodSignature($.Boolean, [$asm0E.TypeRef("System.Collections.Generic.IList`1", [$asm07.TypeRef("Fusee.Math.Core.float3")])]), 
...
(function $lGetHalfEdgesWChangedWinding$gd__7$Members () {
  ...
  var $T02 = function () {
    return ($T02 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerator$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge))) ();
  };
  var $T03 = function () {
  ...
  var $T06 = function () {
    return ($T06 = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Vertex))) ();
  };
  var $T07 = function () {
  ...
  var $T0A = function () {
    return ($T0A = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge))) ();
  };
  var $T0B = function () {
  ...
  var $IM01 = function () {
    return ($IM01 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge).GetEnumerator)) ();
  };
  var $IM02 = function () {
    return ($IM02 = JSIL.Memoize($asm0E.System.Collections.IEnumerator.MoveNext)) ();
  };
  var $IM03 = function () {
    return ($IM03 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerator$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge).get_Current)) ();
  };
  ...
  JSIL.MakeType({
    ...
    $.Method({Static:false, Public:false, Virtual:true }, "System.Collections.Generic.IEnumerable$lFusee.Jometri.DCEL.HalfEdge$g.GetEnumerator", 
      JSIL.MethodSignature.Return($asm0E.TypeRef("System.Collections.Generic.IEnumerator`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")])), 
      $lGetHalfEdgesWChangedWinding$gd__7_System_Collections_Generic_IEnumerable$lFusee_Jometri_DCEL_HalfEdge$g_GetEnumerator
    )
      .Overrides($asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")]), "GetEnumerator")
      .Attribute($asm0E.TypeRef("System.Diagnostics.DebuggerHiddenAttribute"));
    ...
    $.Method({Static:false, Public:false, Virtual:true }, "System.Collections.Generic.IEnumerator$lFusee.Jometri.DCEL.HalfEdge$g.get_Current", 
      ...
      .Overrides($asm0E.TypeRef("System.Collections.Generic.IEnumerator`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")]), "get_Current")
      .Attribute($asm0E.TypeRef("System.Diagnostics.DebuggerHiddenAttribute"));
    ...
    $.Field({Static:false, Public:false}, "originHEdges", $asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")]));

    $.Field({Static:false, Public:true }, "$l$g3__originHEdges", $asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")]));

    $.Field({Static:false, Public:false}, "$l$gs__1", $asm0E.TypeRef("System.Collections.Generic.IEnumerator`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")]));
    ...
    $.ImplementInterfaces(
      /* 0 */ $asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")]), 
      /* 1 */ $asm0E.TypeRef("System.Collections.IEnumerable"), 
      /* 2 */ $asm0E.TypeRef("System.Collections.Generic.IEnumerator`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")]), 
      /* 3 */ $asm0E.TypeRef("System.Collections.IEnumerator"), 
      /* 4 */ $asm0E.TypeRef("System.IDisposable")
    );
...
(function SweepLineStatus$Members () {
  var $, $thisType;
  var $T00 = function () {
    return ($T00 = JSIL.Memoize($asm06.Fusee.Jometri.BinarySearchTree$b2.Of($asm0E.System.Single, $asm06.Fusee.Jometri.Triangulation.StatusEdge))) ();
  };
  var $T01 = function () {
    return ($T01 = JSIL.Memoize($asm0E.System.Int32)) ();
  };
  var $T02 = function () {
    return ($T02 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerator$b1.Of($asm06.Fusee.Jometri.Triangulation.StatusEdge))) ();
  };
  var $T03 = function () {
    return ($T03 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm06.Fusee.Jometri.Triangulation.StatusEdge))) ();
  };
  var $T04 = function () {
    return ($T04 = JSIL.Memoize($asm0E.System.Collections.IEnumerator)) ();
  };
  var $T05 = function () {
  ...
  var $T09 = function () {
    return ($T09 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerator$b1.Of($asm06.Fusee.Jometri.Node$b2.Of($asm0E.System.Single, $asm06.Fusee.Jometri.Triangulation.StatusEdge)))) ();
  };
  var $T0A = function () {
    return ($T0A = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm06.Fusee.Jometri.Node$b2.Of($asm0E.System.Single, $asm06.Fusee.Jometri.Triangulation.StatusEdge)))) ();
  };
  var $T0B = function () {
    return ($T0B = JSIL.Memoize($asm06.Fusee.Jometri.Node$b2.Of($asm0E.System.Single, $asm06.Fusee.Jometri.Triangulation.StatusEdge))) ();
  };
  var $IM00 = function () {
    return ($IM00 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm06.Fusee.Jometri.Triangulation.StatusEdge).GetEnumerator)) ();
  };
  var $IM01 = function () {
    return ($IM01 = JSIL.Memoize($asm0E.System.Collections.IEnumerator.MoveNext)) ();
  };
  var $IM02 = function () {
    return ($IM02 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerator$b1.Of($asm06.Fusee.Jometri.Triangulation.StatusEdge).get_Current)) ();
  };
  var $IM03 = function () {
    return ($IM03 = JSIL.Memoize($asm0E.System.IDisposable.Dispose)) ();
  };
  var $IM04 = function () {
    return ($IM04 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm06.Fusee.Jometri.Node$b2.Of($asm0E.System.Single, $asm06.Fusee.Jometri.Triangulation.StatusEdge)).GetEnumerator)) ();
  };
  var $IM05 = function () {
    return ($IM05 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerator$b1.Of($asm06.Fusee.Jometri.Node$b2.Of($asm0E.System.Single, $asm06.Fusee.Jometri.Triangulation.StatusEdge)).get_Current)) ();
  };
  ...
  JSIL.MakeType({
      BaseType: $asm06.TypeRef("Fusee.Jometri.BinarySearchTree`2", [$asm0E.TypeRef("System.Single"), $asm06.TypeRef("Fusee.Jometri.Triangulation.StatusEdge")]), 
...
(function Triangulation$Members () {
  ...
  var $T03 = function () {
    return ($T03 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge))) ();
  };
  var $T04 = function () {
    return ($T04 = JSIL.Memoize($asm06.Fusee.Jometri.DCEL.Vertex)) ();
  };
  var $T05 = function () {
    return ($T05 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerator$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge))) ();
  };
  var $T06 = function () {
  ...
  var $T10 = function () {
    return ($T10 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex))) ();
  };
  var $T11 = function () {
    return ($T11 = JSIL.Memoize($asm06.Fusee.Jometri.Triangulation.Triangulation_$l$gc__DisplayClass20_0)) ();
  };
  var $T12 = function () {
    return ($T12 = JSIL.Memoize($asm0E.System.Collections.Generic.List$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex))) ();
  };
  var $T13 = function () {
    return ($T13 = JSIL.Memoize($asm0E.System.Comparison$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex))) ();
  };
  var $T14 = function () {
    return ($T14 = JSIL.Memoize($asm0E.System.Collections.Generic.ICollection$b1.Of($asm06.Fusee.Jometri.DCEL.Face))) ();
  };
  var $T15 = function () {
  ...
  var $T17 = function () {
    return ($T17 = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Face))) ();
  };
  var $T18 = function () {
    return ($T18 = JSIL.Memoize($asm12.System.Linq.Enumerable)) ();
  };
  var $T19 = function () {
    return ($T19 = JSIL.Memoize($asm06.Fusee.Jometri.BinarySearchTree$b2.Of($asm0E.System.Single, $asm06.Fusee.Jometri.Triangulation.StatusEdge))) ();
  };
  var $T1A = function () {
    return ($T1A = JSIL.Memoize($asm0E.System.Single)) ();
  };
  var $T1B = function () {
    return ($T1B = JSIL.Memoize($asm0E.System.Collections.Generic.IList$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge))) ();
  };
  var $T1C = function () {
    return ($T1C = JSIL.Memoize($asm0E.System.Collections.Generic.IDictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.Triangulation.VertexType))) ();
  };
  var $T1D = function () {
    return ($T1D = JSIL.Memoize($asm06.Fusee.Jometri.Triangulation.VertexType)) ();
  };
  var $T1E = function () {
    return ($T1E = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerator$b1.Of($asm0E.System.Collections.Generic.KeyValuePair$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.Triangulation.VertexType)))) ();
  };
  var $T1F = function () {
    return ($T1F = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm0E.System.Collections.Generic.KeyValuePair$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.Triangulation.VertexType)))) ();
  };
  var $T20 = function () {
    return ($T20 = JSIL.Memoize($asm0E.System.Collections.Generic.KeyValuePair$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.Triangulation.VertexType))) ();
  };
  var $T21 = function () {
    return ($T21 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerator$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex))) ();
  };
  var $T22 = function () {
    return ($T22 = JSIL.Memoize($asm0E.System.Collections.Generic.List$b1.Of($asm0E.System.Int32))) ();
  };
  var $T23 = function () {
    return ($T23 = JSIL.Memoize($asm07.Fusee.Math.Core.float3)) ();
  };
  var $T24 = function () {
    return ($T24 = JSIL.Memoize($asm0E.System.Collections.Generic.List$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge))) ();
  };
  var $T25 = function () {
    return ($T25 = JSIL.Memoize($asm0E.System.Collections.Generic.List$b1.Of($asm06.Fusee.Jometri.DCEL.Face))) ();
  };
  var $T26 = function () {
    return ($T26 = JSIL.Memoize($asm0E.System.UInt32)) ();
  };
  var $T27 = function () {
    return ($T27 = JSIL.Memoize($asm0E.System.Collections.Generic.ICollection$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex))) ();
  };
  var $T28 = function () {
    return ($T28 = JSIL.Memoize($asm0E.System.ArgumentOutOfRangeException)) ();
  };
  var $T29 = function () {
    return ($T29 = JSIL.Memoize($asm06.Fusee.Jometri.GeometricOperations)) ();
  };
  var $T2A = function () {
    return ($T2A = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2_Enumerator.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Face))) ();
  };
  var $T2B = function () {
    return ($T2B = JSIL.Memoize($asm0E.System.Collections.Generic.KeyValuePair$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Face))) ();
  };
  var $T2C = function () {
    return ($T2C = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.Triangulation.VertexType))) ();
  };
  var $T2D = function () {
    return ($T2D = JSIL.Memoize($asm10.System.Collections.Generic.Stack$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex))) ();
  };
  var $T2E = function () {
    return ($T2E = JSIL.Memoize($asm00.Fusee.Base.Common.ExtensionMethods)) ();
  };
  var $S00 = function () {
    return ($S00 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.ArgumentException, [$asm0E.System.String]))) ();
  };
  var $S01 = function () {
    return ($S01 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.List$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex), null))) ();
  };
  var $S02 = function () {
    return ($S02 = JSIL.Memoize(new JSIL.MethodSignature(null, [$asm0E.TypeRef("System.Comparison`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")])]))) ();
  };
  var $S03 = function () {
    return ($S03 = JSIL.Memoize(new JSIL.MethodSignature($asm0E.System.Int32, [$asm06.Fusee.Jometri.DCEL.Vertex, $asm06.Fusee.Jometri.DCEL.Vertex]))) ();
  };
  var $S04 = function () {
  ...
  var $S05 = function () {
    return ($S05 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.List$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex), [$asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")])]))) ();
  };
  var $S06 = function () {
    return ($S06 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.List$b1.Of($asm06.Fusee.Jometri.DCEL.Face), null))) ();
  };
  var $S07 = function () {
    return ($S07 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.ArgumentOutOfRangeException, null))) ();
  };
  var $S08 = function () {
    return ($S08 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Face), [$asm0E.TypeRef("System.Collections.Generic.IDictionary`2", [$asm0E.TypeRef("System.Int32"), $asm06.TypeRef("Fusee.Jometri.DCEL.Face")])]))) ();
  };
  var $S09 = function () {
    return ($S09 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.Triangulation.VertexType), null))) ();
  };
  var $S0A = function () {
    return ($S0A = JSIL.Memoize(new JSIL.MethodSignature(null, [$asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")]))) ();
  };
  var $S0B = function () {
    return ($S0B = JSIL.Memoize(new JSIL.ConstructorSignature($asm10.System.Collections.Generic.Stack$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex), null))) ();
  };
  var $IM00 = function () {
    return ($IM00 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge).GetEnumerator)) ();
  };
  var $IM01 = function () {
    return ($IM01 = JSIL.Memoize($asm0E.System.Collections.IEnumerator.MoveNext)) ();
  };
  var $IM02 = function () {
    return ($IM02 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerator$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge).get_Current)) ();
  };
  var $IM03 = function () {
    return ($IM03 = JSIL.Memoize($asm0E.System.IDisposable.Dispose)) ();
  };
  var $IM04 = function () {
    return ($IM04 = JSIL.Memoize($asm0E.System.Collections.Generic.ICollection$b1.Of($asm06.Fusee.Jometri.DCEL.Face).Add)) ();
  };
  var $IM05 = function () {
    return ($IM05 = JSIL.Memoize($asm0E.System.Collections.Generic.IDictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.Triangulation.VertexType).Add)) ();
  };
  var $IM06 = function () {
    return ($IM06 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm0E.System.Collections.Generic.KeyValuePair$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.Triangulation.VertexType)).GetEnumerator)) ();
  };
  var $IM07 = function () {
    return ($IM07 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerator$b1.Of($asm0E.System.Collections.Generic.KeyValuePair$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.Triangulation.VertexType)).get_Current)) ();
  };
  var $IM08 = function () {
    return ($IM08 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex).GetEnumerator)) ();
  };
  var $IM09 = function () {
    return ($IM09 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerator$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex).get_Current)) ();
  };
  var $IM0A = function () {
    return ($IM0A = JSIL.Memoize($asm0E.System.Collections.Generic.ICollection$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex).get_Count)) ();
  };
  var $IM0B = function () {
    return ($IM0B = JSIL.Memoize($asm0E.System.Collections.Generic.IList$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex).get_Item)) ();
  };
  var $IM0C = function () {
    return ($IM0C = JSIL.Memoize($asm0E.System.Collections.Generic.IDictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.Triangulation.VertexType).get_Item)) ();
  };
  var $IM0D = function () {
    return ($IM0D = JSIL.Memoize($asm0E.System.Collections.Generic.IList$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex).RemoveAt)) ();
  };
  ...
  function Triangulation_GetSortedVertices (geometry, face, unsortedVerts) {
    ...
    $S02().Call($T12().prototype, "Sort", null, sorted, $T13().New($closure0, null, new JSIL.MethodPointerInfo($asm06.Fusee.Jometri.Triangulation.Triangulation_$l$gc__DisplayClass20_0, "$lGetSortedVertices$gb__0", $S03(), false, false)));
    return sorted;
  }; 
  ...
  function Triangulation_HandleEndVertex (vert, faceHalfEdges, newFaces) {
    ...
    $loop0: 
      while ($IM01().Call(enumerator, null)) {
        ...
        if (!flag) {
          var eMinOne = $thisType._sweepLineStatus.FindStatusEdgeWithHandle(he.PrevHalfEdge);
          var isMergeVertex = eMinOne.IsMergeVertex;
          if (isMergeVertex) {
            $thisType._geometry.InsertDiagonal(vert.Handle, eMinOne.HelperVertexHandle);
          ...
          $T19().prototype.DeleteNode.call($thisType._sweepLineStatus, eMinOne.IntersectionPointX);
          break $loop0;
        }
      }
    } finally {
  ...
  function Triangulation_HandleMergeVertex (face, vert, faceHalfEdges, newFaces) {
    ...
    var ej = $T19().prototype.FindLargestSmallerThanInBalanced.call($thisType._sweepLineStatus, redXPos);
    var isMergeVertex2 = ej.IsMergeVertex;
    if (isMergeVertex2) {
      $thisType._geometry.InsertDiagonal(vert.Handle, ej.HelperVertexHandle);
      $IM04().Call(newFaces, null, $thisType._geometry.Geometry$DictFaces$value.get_Item($S04().CallStatic($T18(), "Max", null, $thisType._geometry.Geometry$DictFaces$value.get_Keys())).MemberwiseClone());
    }
    $T19().prototype.FindNode.call($thisType._sweepLineStatus, ej.IntersectionPointX).HelperVertexHandle = (vert.Handle | 0);
    $T19().prototype.FindNode.call($thisType._sweepLineStatus, ej.IntersectionPointX).IsMergeVertex = true;
  }; 
  ...
  function Triangulation_HandleRegularVertex (face, vert, faceHalfEdges, newFaces) {
    ...
    if (flag) {
      ...
      $loop0: 
        while ($IM01().Call(enumerator, null)) {
          ...
          if (!flag2) {
            ...
            $T19().prototype.InsertNode.call($thisType._sweepLineStatus, ei.IntersectionPointX, ei);
            break $loop0;
          }
        }
      } finally {
      ...
      $T19().prototype.FindNode.call($thisType._sweepLineStatus, ej.IntersectionPointX).HelperVertexHandle = (vert.Handle | 0);
      $T19().prototype.FindNode.call($thisType._sweepLineStatus, ej.IntersectionPointX).IsMergeVertex = false;
    }
  }; 
  ...
  function Triangulation_HasNoSplitOrMerge (face, vertTypes) {
    var $temp00;
    var vertType = new JSIL.BoxedVariable($asm06.Fusee.Jometri.Triangulation.VertexType.START_VERTEX);
    var verts = $T18().ToList$b1($T04())($thisType._geometry.GetFaceVertices(face.Handle));
    ...
    try {
      ...
      while ($IM01().Call(enumerator2, null)) {
        ...
        var flag = (JSIL.ObjectEqualsInstance(vert2.get_Value(), $T1D().SPLIT_VERTEX, !false, $T0D().__Type__)) || 
        (JSIL.ObjectEqualsInstance(vert2.get_Value(), $T1D().MERGE_VERTEX, !false, $T0D().__Type__));
        if (flag) {
          var result = false;
          return result;
        }
  ...
  function Triangulation_MakeMonotone (face, vertTypes) {
    var vertices = $S05().Construct($thisType._geometry.GetFaceVertices(face.Handle));
    var sortedVertices = $thisType.GetSortedVertices($thisType._geometry, face.MemberwiseClone(), $T18().ToList$b1($T04())(vertices));
    ...
    while (($IM0A().Call(sortedVertices, null) >>> 0) > (0 >>> 0)) {
      ...
      $thisType._sweepLineStatus.UpdateNodes(current.MemberwiseClone());
  ...
  function Triangulation_TestVertexType (vert, face, /* ref */ vertType) {
    var $temp00;
    var heStartingAtFace = $T18().ToList$b1($T07())($thisType._geometry.GetVertexStartingHalfEdges(vert.Handle));
  ...
  $loop0: 
    ...
    if (flag2) {
      var flag3 = $T29().IsAngleGreaterPi(
        $thisType._geometry, 
      ...
      if (flag4) {
        var flag5 = $T29().IsAngleGreaterPi(
          $thisType._geometry, 
          face.MemberwiseClone(), 
          nextVert.MemberwiseClone(), 
          vert.MemberwiseClone(), 
  ...
  function Triangulation_Triangulate (geometry) {
    ...
    var originalFaces = $S08().Construct($thisType._geometry.Geometry$DictFaces$value);
    var enumerator = $T17().prototype.GetEnumerator.call(originalFaces);

    while ($T2A().prototype.MoveNext.call(enumerator)) {
      var face = $T2A().prototype.get_Current.call(enumerator).MemberwiseClone();
    ...
    var monotoneFaces = $S08().Construct($thisType._geometry.Geometry$DictFaces$value);
    var enumerator2 = $T17().prototype.GetEnumerator.call(monotoneFaces);

    while ($T2A().prototype.MoveNext.call(enumerator2)) {
      var face2 = $T2A().prototype.get_Current.call(enumerator2).MemberwiseClone();
  ...
  function Triangulation_TriangulateMonotone (face) {
    ...
    try {
      ...
      while ($IM01().Call(enumerator, null)) {
        ...
        $S0A().CallVirtual("Add", null, faceVertices, vHandle.MemberwiseClone());
      }
    } finally {
      if (enumerator !== null) {
        $IM03().Call(enumerator, null);
    ...
    if (!flag) {
      ...
      var vertStack = $S0B().Construct();
      var leftChain = $T18().ToList$b1($T04())($thisType.GetLeftChain(sortedVerts, face.MemberwiseClone()));
      $T2D().prototype.Push.call(vertStack, $IM0B().Call(sortedVerts, null, 0).MemberwiseClone());
      $T2D().prototype.Push.call(vertStack, $IM0B().Call(sortedVerts, null, 1).MemberwiseClone());
      ...
      for (var i = 2; i < ((($IM0A().Call(sortedVerts, null) | 0) - 1) | 0); i = ((i + 1) | 0)) {
        ...
        var flag2 = (!$thisType.IsLeftChain(leftChain, current) && 
          $thisType.IsLeftChain(leftChain, $T2D().prototype.Peek.call(vertStack))) || 
        ($thisType.IsLeftChain(leftChain, current) && 
          !$thisType.IsLeftChain(leftChain, $T2D().prototype.Peek.call(vertStack)));
        if (flag2) {

          while ((vertStack.get_Count() | 0) > 0) {
            var popped = $T2D().prototype.Pop.call(vertStack).MemberwiseClone();
            var flag3 = (vertStack.get_Count() | 0) > 0;
            if (flag3) {
              $thisType._geometry.InsertDiagonal(current.Handle, popped.Handle);
            }
          }
          $T2D().prototype.Push.call(vertStack, $IM0B().Call(sortedVerts, null, ((i - 1) | 0)).MemberwiseClone());
          $T2D().prototype.Push.call(vertStack, current.MemberwiseClone());
        } else {
          var popped2 = $T2D().prototype.Pop.call(vertStack).MemberwiseClone();
          var flag4 = $thisType.IsLeftChain(leftChain, popped2);
          if (flag4) {
            var next = $IM0B().Call(sortedVerts, null, i).MemberwiseClone();
            var prev = $T2D().prototype.Peek.call(vertStack).MemberwiseClone();
          } else {
            next = $T2D().prototype.Peek.call(vertStack).MemberwiseClone();
            prev = $IM0B().Call(sortedVerts, null, i).MemberwiseClone();
          }

          while (((vertStack.get_Count() | 0) > 0) && !$T29().IsAngleGreaterOrEqualPi(
              $thisType._geometry, 
              face.MemberwiseClone(), 
            ...
            popped2 = $T2D().prototype.Pop.call(vertStack).MemberwiseClone();
            ...
            if (flag5) {
              ...
              if (flag6) {
                ...
                prev = $T2D().prototype.Peek.call(vertStack).MemberwiseClone();
              } else {
                next = $T2D().prototype.Peek.call(vertStack).MemberwiseClone();
                prev = $IM0B().Call(sortedVerts, null, i).MemberwiseClone();
              }
            }
            $thisType._geometry.InsertDiagonal(current.Handle, popped2.Handle);
          }
          $T2D().prototype.Push.call(vertStack, popped2.MemberwiseClone());
          $T2D().prototype.Push.call(vertStack, current.MemberwiseClone());
        }
      }
      ...
      for (var j = 0; j < count; j = ((j + 1) | 0)) {
        var popped3 = $T2D().prototype.Pop.call(vertStack).MemberwiseClone();
        var flag7 = j === 0;
        if (!flag7) {
          var flag8 = j !== ((count - 1) | 0);
          if (flag8) {
            $thisType._geometry.InsertDiagonal($T2E().LastItem$b1($T04())(sortedVerts).Handle, popped3.Handle);
          }
        }
      }
    }
  ...
  JSIL.MakeStaticClass("Fusee.Jometri.Triangulation.Triangulation", true, [], function ($ib) {
    ...
    $.Method({Static:true , Public:false}, "GetLeftChain", 
      new JSIL.MethodSignature($asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")]), [$asm0E.TypeRef("System.Collections.Generic.IList`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")]), $asm06.TypeRef("Fusee.Jometri.DCEL.Face")]), 
    ...
    $.Method({Static:true , Public:false}, "GetNextVertex", 
      new JSIL.MethodSignature($asm06.TypeRef("Fusee.Jometri.DCEL.Vertex"), [
          $asm06.TypeRef("Fusee.Jometri.DCEL.Face"), $asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")]), 
          $asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")
        ]), 
    ...
    $.Method({Static:true , Public:false}, "GetSortedVertices", 
      new JSIL.MethodSignature($asm0E.TypeRef("System.Collections.Generic.IList`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")]), [
          $asm06.TypeRef("Fusee.Jometri.DCEL.Geometry"), $asm06.TypeRef("Fusee.Jometri.DCEL.Face"), 
          $asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")])
        ]), 
    ...
    $.Method({Static:true , Public:false}, "HandleEndVertex", 
      new JSIL.MethodSignature(null, [
          $asm06.TypeRef("Fusee.Jometri.DCEL.Vertex"), $asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")]), 
          $asm0E.TypeRef("System.Collections.Generic.ICollection`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Face")])
        ]), 
    ...
    $.Method({Static:true , Public:false}, "HandleMergeVertex", 
      new JSIL.MethodSignature(null, [
          ...
          $asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")]), $asm0E.TypeRef("System.Collections.Generic.ICollection`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Face")])
        ]), 
    ...
    $.Method({Static:true , Public:false}, "HandleRegularVertex", 
      new JSIL.MethodSignature(null, [
          $asm06.TypeRef("Fusee.Jometri.DCEL.Face"), $asm06.TypeRef("Fusee.Jometri.DCEL.Vertex"), 
          $asm0E.TypeRef("System.Collections.Generic.IList`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")]), $asm0E.TypeRef("System.Collections.Generic.ICollection`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Face")])
        ]), 
    ...
    $.Method({Static:true , Public:false}, "HandleStartVertex", 
      new JSIL.MethodSignature(null, [
          $asm06.TypeRef("Fusee.Jometri.DCEL.Face"), $asm06.TypeRef("Fusee.Jometri.DCEL.Vertex"), 
          $asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")])
        ]), 
      Triangulation_HandleStartVertex
    );

    $.Method({Static:true , Public:false}, "HasNoSplitOrMerge", 
      new JSIL.MethodSignature($.Boolean, [$asm06.TypeRef("Fusee.Jometri.DCEL.Face"), $asm0E.TypeRef("System.Collections.Generic.IDictionary`2", [$.Int32, $asm06.TypeRef("Fusee.Jometri.Triangulation.VertexType")])]), 
      Triangulation_HasNoSplitOrMerge
    );

    $.Method({Static:true , Public:false}, "IsLeftChain", 
      new JSIL.MethodSignature($.Boolean, [$asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")]), $asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")]), 
    ...
    $.Method({Static:true , Public:false}, "IsPolygonRightOfVert", 
      new JSIL.MethodSignature($.Boolean, [
          $asm06.TypeRef("Fusee.Jometri.DCEL.Geometry"), $asm06.TypeRef("Fusee.Jometri.DCEL.Face"), 
          $asm0E.TypeRef("System.Collections.Generic.IList`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")]), $asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")
        ]), 
    ...
    $.Method({Static:true , Public:false}, "MakeMonotone", 
      new JSIL.MethodSignature(null, [$asm06.TypeRef("Fusee.Jometri.DCEL.Face"), $asm0E.TypeRef("System.Collections.Generic.IDictionary`2", [$.Int32, $asm06.TypeRef("Fusee.Jometri.Triangulation.VertexType")])]), 
...
(function $lGetLeftChain$gd__4$Members () {
  ...
  var $T08 = function () {
    return ($T08 = JSIL.Memoize($asm0E.System.Collections.Generic.IList$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex))) ();
  };
  var $T09 = function () {
    return ($T09 = JSIL.Memoize($asm0E.System.Boolean)) ();
  };
  var $T0A = function () {
    return ($T0A = JSIL.Memoize($asm0E.System.Collections.Generic.List$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge))) ();
  };
  var $T0B = function () {
    return ($T0B = JSIL.Memoize($asm0E.System.Collections.Generic.List$b1_Enumerator.Of($asm06.Fusee.Jometri.DCEL.HalfEdge))) ();
  };
  var $T0C = function () {
    return ($T0C = JSIL.Memoize($asm0E.System.NotSupportedException)) ();
  };
  ...
  var $IM00 = function () {
    return ($IM00 = JSIL.Memoize($asm0E.System.Collections.Generic.IList$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex).get_Item)) ();
  };
  ...
  JSIL.MakeType({
    ...
    $.Method({Static:false, Public:false, Virtual:true }, "System.Collections.Generic.IEnumerable$lFusee.Jometri.DCEL.Vertex$g.GetEnumerator", 
      JSIL.MethodSignature.Return($asm0E.TypeRef("System.Collections.Generic.IEnumerator`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")])), 
      $lGetLeftChain$gd__4_System_Collections_Generic_IEnumerable$lFusee_Jometri_DCEL_Vertex$g_GetEnumerator
    )
      .Overrides($asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")]), "GetEnumerator")
      .Attribute($asm0E.TypeRef("System.Diagnostics.DebuggerHiddenAttribute"));
    ...
    $.Method({Static:false, Public:false, Virtual:true }, "System.Collections.Generic.IEnumerator$lFusee.Jometri.DCEL.Vertex$g.get_Current", 
      ...
      .Overrides($asm0E.TypeRef("System.Collections.Generic.IEnumerator`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")]), "get_Current")
      .Attribute($asm0E.TypeRef("System.Diagnostics.DebuggerHiddenAttribute"));
    ...
    $.Field({Static:false, Public:false}, "sortedVerts", $asm0E.TypeRef("System.Collections.Generic.IList`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")]));

    $.Field({Static:false, Public:true }, "$l$g3__sortedVerts", $asm0E.TypeRef("System.Collections.Generic.IList`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")]));
    ...
    $.Field({Static:false, Public:false}, "$lstartingAtFirstV$g5__3", $asm0E.TypeRef("System.Collections.Generic.List`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")]));

    $.Field({Static:false, Public:false}, "$l$gs__4", $asm0E.TypeRef("System.Collections.Generic.List`1+Enumerator", [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")]));
    ...
    $.ImplementInterfaces(
      /* 0 */ $asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")]), 
      /* 1 */ $asm0E.TypeRef("System.Collections.IEnumerable"), 
      /* 2 */ $asm0E.TypeRef("System.Collections.Generic.IEnumerator`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")]), 
      /* 3 */ $asm0E.TypeRef("System.Collections.IEnumerator"), 
      /* 4 */ $asm0E.TypeRef("System.IDisposable")
    );
...
(function Extrude$Members () {
  ...
  var $T07 = function () {
    return ($T07 = JSIL.Memoize($asm0E.System.Collections.Generic.List$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge))) ();
  };
  var $T08 = function () {
    return ($T08 = JSIL.Memoize($asm0E.System.Collections.Generic.List$b1.Of($asm06.Fusee.Jometri.DCEL.Face))) ();
  };
  var $T09 = function () {
    return ($T09 = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Face))) ();
  };
  var $T0A = function () {
    return ($T0A = JSIL.Memoize($asm0E.System.Boolean)) ();
  };
  var $T0B = function () {
    return ($T0B = JSIL.Memoize($asm0E.System.UInt32)) ();
  };
  var $T0C = function () {
    return ($T0C = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.HalfEdge))) ();
  };
  var $T0D = function () {
  ...
  var $T10 = function () {
    return ($T10 = JSIL.Memoize($asm07.Fusee.Math.Core.float3)) ();
  };
  var $T11 = function () {
    return ($T11 = JSIL.Memoize($asm06.Fusee.Jometri.GeometricOperations)) ();
  };
  var $T12 = function () {
    return ($T12 = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Vertex))) ();
  };
  var $T13 = function () {
    return ($T13 = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2_Enumerator.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Vertex))) ();
  };
  var $T14 = function () {
    return ($T14 = JSIL.Memoize($asm0E.System.Collections.Generic.KeyValuePair$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Vertex))) ();
  };
  var $T15 = function () {
    return ($T15 = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2_Enumerator.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Face))) ();
  };
  var $T16 = function () {
    return ($T16 = JSIL.Memoize($asm0E.System.Collections.Generic.KeyValuePair$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Face))) ();
  };
  var $T17 = function () {
    return ($T17 = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2_Enumerator.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.HalfEdge))) ();
  };
  var $T18 = function () {
    return ($T18 = JSIL.Memoize($asm0E.System.Collections.Generic.KeyValuePair$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.HalfEdge))) ();
  };
  var $T19 = function () {
    return ($T19 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerator$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge))) ();
  };
  var $T1A = function () {
    return ($T1A = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge))) ();
  };
  var $T1B = function () {
    return ($T1B = JSIL.Memoize($asm0E.System.Collections.IEnumerator)) ();
  };
  var $T1C = function () {
    return ($T1C = JSIL.Memoize($asm0E.System.IDisposable)) ();
  };
  var $T1D = function () {
    return ($T1D = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex))) ();
  };
  var $T1E = function () {
    return ($T1E = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerator$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex))) ();
  };
  var $S00 = function () {
    return ($S00 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.List$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge), null))) ();
  };
  var $S01 = function () {
    return ($S01 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.List$b1.Of($asm06.Fusee.Jometri.DCEL.Face), null))) ();
  };
  var $S02 = function () {
  ...
  var $S05 = function () {
    return ($S05 = JSIL.Memoize(new JSIL.ConstructorSignature($asm06.Fusee.Jometri.DCEL.Geometry, null))) ();
  };
  var $S06 = function () {
    return ($S06 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Face), [$asm0E.TypeRef("System.Collections.Generic.IDictionary`2", [$asm0E.TypeRef("System.Int32"), $asm06.TypeRef("Fusee.Jometri.DCEL.Face")])]))) ();
  };
  var $S07 = function () {
    return ($S07 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Vertex), [$asm0E.TypeRef("System.Collections.Generic.IDictionary`2", [$asm0E.TypeRef("System.Int32"), $asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")])]))) ();
  };
  var $S08 = function () {
    return ($S08 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.HalfEdge), [$asm0E.TypeRef("System.Collections.Generic.IDictionary`2", [$asm0E.TypeRef("System.Int32"), $asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")])]))) ();
  };
  var $S09 = function () {
    return ($S09 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Vertex), null))) ();
  };
  var $S0A = function () {
    return ($S0A = JSIL.Memoize(new JSIL.MethodSignature(null, [$asm0E.System.Int32, $asm07.Fusee.Math.Core.float3]))) ();
  };
  var $S0B = function () {
    return ($S0B = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Face), null))) ();
  };
  var $S0C = function () {
    return ($S0C = JSIL.Memoize(new JSIL.MethodSignature(null, [$asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Face]))) ();
  };
  var $S0D = function () {
    return ($S0D = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.HalfEdge), null))) ();
  };
  var $S0E = function () {
    return ($S0E = JSIL.Memoize(new JSIL.MethodSignature($asm0E.System.Int32, [$asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm0E.System.Int32)]))) ();
  };
  var $S0F = function () {
    return ($S0F = JSIL.Memoize(new JSIL.ConstructorSignature($asm07.Fusee.Math.Core.float3, [
  ...
  var $S11 = function () {
    return ($S11 = JSIL.Memoize(new JSIL.MethodSignature(null, [$asm06.Fusee.Jometri.DCEL.Vertex, $asm07.Fusee.Math.Core.float3]))) ();
  };
  var $IM00 = function () {
    return ($IM00 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge).GetEnumerator)) ();
  };
  ...
  var $IM04 = function () {
    return ($IM04 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex).GetEnumerator)) ();
  };
  var $IM05 = function () {
    return ($IM05 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerator$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex).get_Current)) ();
  };
  ...
  function Extrude_CreateSidefaces (geometry) {
    ...
    var frontLoopsStartHalfEdges = $T05().ToList$b1($T04())($T06().TakeItems$b1($T04())(unboundedFace.InnerHalfEdges, ((((unboundedFace.InnerHalfEdges).get_Count() | 0) / 2) | 0)));
    var backLoopsStartHalfEdges = $T05().ToList$b1($T04())($T06().SkipItems$b1($T04())(unboundedFace.InnerHalfEdges, ((((unboundedFace.InnerHalfEdges).get_Count() | 0) / 2) | 0)));
    ...
    for (var i = 0; i < (frontLoopsStartHalfEdges.get_Count() | 0); i = ((i + 1) | 0)) {
      ...
      for (var k = 0; k < (newHalfEdges.get_Count() | 0); k = ((k + 1) | 0)) {
        ...
        var flag = k === 0;
        if (flag) {
          current.TwinHalfEdge = ($T06().LastItem$b1($T01())(newHalfEdges).Handle | 0);
        } else {
      ...
      for (var a$0 = newFaces._items, i$0 = 0, l$0 = (newFaces._size | 0); i$0 < l$0; ($temp00 = i$0, 
        ...
        geometry.SetFaceNormal(
          $T05().ToList$b1($T0D())(geometry.GetFaceOuterVertices(face.Handle)), 
  ...
  function Extrude_CreateTopSurface (geometry, zOffset, exturdeAlongNormal) {
    ...
    if (flag) {
      ...
      var unbounded = $T05().ToList$b1($T0D())(backface.GetFaceVertices(1));
      var normal = $T11().CalculateFaceNormal(unbounded).MemberwiseClone();
  ...
  function Extrude_Join2DGeometries (first, second) {
    var $temp00, $temp01;
    var vert = new ($T0D())(), face = new ($T02())(), halfEdge = new ($T01())();
    ...
    var vertDictHelper = $S09().Construct();
    var enumerator = $T12().prototype.GetEnumerator.call(second.Geometry$DictVertices$value);

    while ($T13().prototype.MoveNext.call(enumerator)) {
      var v = $T13().prototype.get_Current.call(enumerator);
      (vert = vert.MemberwiseClone(), 
        $S0A().Call($T0D().prototype, "_ctor", null, vert, 
    ...
    var faceDictHelper = $S0B().Construct();
    var enumerator2 = $T09().prototype.GetEnumerator.call(second.Geometry$DictFaces$value);

    while ($T15().prototype.MoveNext.call(enumerator2)) {
      var f = $T15().prototype.get_Current.call(enumerator2).MemberwiseClone();
    ...
    var heDictHelper = $S0D().Construct();
    var enumerator3 = $T0C().prototype.GetEnumerator.call(second.Geometry$DictHalfEdges$value);

    while ($T17().prototype.MoveNext.call(enumerator3)) {
      var he = $T17().prototype.get_Current.call(enumerator3);
      (halfEdge = halfEdge.MemberwiseClone(), 
    ...
    var hEdgesWChangedWinding = $T05().ToList$b1($T01())($T11().GetHalfEdgesWChangedWinding(second, second.GetAllHalfEdges()));
    var enumerator4 = $T12().prototype.GetEnumerator.call(second.Geometry$DictVertices$value);

    while ($T13().prototype.MoveNext.call(enumerator4)) {
      var vert2 = $T13().prototype.get_Current.call(enumerator4).MemberwiseClone();
    ...
    var firstUnbounded = (first.Geometry$DictFaces$value).get_Item($S0E().CallStatic($T05(), "Min", null, (first.Geometry$DictFaces$value).get_Keys())).MemberwiseClone();
    var secUnbounded = (second.Geometry$DictFaces$value).get_Item($S0E().CallStatic($T05(), "Min", null, (second.Geometry$DictFaces$value).get_Keys())).MemberwiseClone();
    ...
    try {
      ...
      while ($IM01().Call(enumerator6, null)) {
        var he2 = $IM02().Call(enumerator6, null).MemberwiseClone();
    ...
    while ($T15().prototype.MoveNext.call(enumerator8)) {
      var face2 = $T15().prototype.get_Current.call(enumerator8).MemberwiseClone();
      (first.Geometry$DictFaces$value).Add(
        face2.get_Key(), 
        face2.get_Value().MemberwiseClone()
      );
      first.SetFaceNormal(
        $T05().ToList$b1($T0D())(first.GetFaceOuterVertices(face2.get_Key())), 
  ...
  function Extrude_UpdateVertexZCoord$00 (geometry, zOffset) {
    ...
    for (var a$0 = $T05().ToList$b1($T04())((geometry.Geometry$DictVertices$value).get_Keys())._items, i$0 = 0, l$0 = ($T05().ToList$b1($T04())((geometry.Geometry$DictVertices$value).get_Keys())._size | 0); i$0 < l$0; ($temp00 = i$0, 
      ...
      v.VertData.Pos = $S0F().Construct(v.VertData.Pos.x, v.VertData.Pos.y, (+v.VertData.Pos.z + +zOffset));
  ...
  function Extrude_UpdateVertexZCoord$01 (backface, verts, normal, zOffset) {
    ...
    try {
      ...
      while ($IM01().Call(enumerator, null)) {
        var v = $IM05().Call(enumerator, null).MemberwiseClone();
        var newPos = $T10().op_Addition(v.VertData.Pos.MemberwiseClone(), $S10().CallStatic($T10(), "op_Multiply", null, normal.MemberwiseClone(), zOffset));
        (vert = vert.MemberwiseClone(), 
          $S11().Call($T0D().prototype, "_ctor", null, vert, v, newPos.MemberwiseClone()));
  ...
  JSIL.MakeStaticClass("Fusee.Jometri.Manipulation.Extrude", true, [], function ($ib) {
    ...
    $.Method({Static:true , Public:false}, "UpdateVertexZCoord", 
      new JSIL.MethodSignature(null, [
          $asm06.TypeRef("Fusee.Jometri.DCEL.Geometry"), $asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")]), 
...
(function PolyBoundary$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:true }, "Points", $asm0E.TypeRef("System.Collections.Generic.IList`1", [$asm07.TypeRef("Fusee.Math.Core.float3")]));
...
(function InitializeGeometryHelper$Members () {
  ...
  var $T02 = function () {
    return ($T02 = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Face))) ();
  };
  var $T03 = function () {
    return ($T03 = JSIL.Memoize($asm06.Fusee.Jometri.DCEL.Geometry)) ();
  };
  var $T04 = function () {
    return ($T04 = JSIL.Memoize($asm0E.System.Collections.Generic.IList$b1.Of($asm0E.System.Collections.Generic.KeyValuePair$b2.Of($asm06.Fusee.Jometri.DCEL.Vertex, $asm0E.System.Boolean)))) ();
  };
  var $T05 = function () {
  ...
  var $T07 = function () {
    return ($T07 = JSIL.Memoize($asm0E.System.Collections.Generic.List$b1.Of($asm06.Fusee.Jometri.DCEL.InitializeGeometryHelper_BoundaryEdge))) ();
  };
  var $T08 = function () {
    return ($T08 = JSIL.Memoize($asm0E.System.Boolean)) ();
  };
  ...
  var $T0A = function () {
    return ($T0A = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.HalfEdge))) ();
  };
  var $T0B = function () {
    return ($T0B = JSIL.Memoize($asm0E.System.Collections.Generic.ICollection$b1.Of($asm0E.System.Collections.Generic.KeyValuePair$b2.Of($asm06.Fusee.Jometri.DCEL.Vertex, $asm0E.System.Boolean)))) ();
  };
  var $T0C = function () {
    return ($T0C = JSIL.Memoize($asm0E.System.Collections.Generic.KeyValuePair$b2.Of($asm06.Fusee.Jometri.DCEL.Vertex, $asm0E.System.Boolean))) ();
  };
  var $T0D = function () {
    return ($T0D = JSIL.Memoize($asm06.Fusee.Jometri.DCEL.Vertex)) ();
  };
  var $T0E = function () {
    return ($T0E = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Vertex))) ();
  };
  var $T0F = function () {
    return ($T0F = JSIL.Memoize($asm12.System.Linq.Enumerable)) ();
  };
  var $T10 = function () {
    return ($T10 = JSIL.Memoize($asm0E.System.Collections.Generic.List$b1.Of($asm0E.System.Int32))) ();
  };
  var $T11 = function () {
    return ($T11 = JSIL.Memoize($asm0E.System.Collections.Generic.KeyValuePair$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Face))) ();
  };
  var $T12 = function () {
    return ($T12 = JSIL.Memoize($asm00.Fusee.Base.Common.ExtensionMethods)) ();
  };
  var $T13 = function () {
    return ($T13 = JSIL.Memoize($asm06.Fusee.Jometri.DCEL.InitializeGeometryHelper_BoundaryEdge)) ();
  };
  var $T14 = function () {
    return ($T14 = JSIL.Memoize($asm0E.System.Collections.Generic.List$b1.Of($asm0E.System.Collections.Generic.KeyValuePair$b2.Of($asm06.Fusee.Jometri.DCEL.Vertex, $asm0E.System.Boolean)))) ();
  };
  var $T15 = function () {
    return ($T15 = JSIL.Memoize($asm0E.System.Collections.Generic.List$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge))) ();
  };
  var $T16 = function () {
    return ($T16 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm06.Fusee.Jometri.DCEL.InitializeGeometryHelper_BoundaryEdge))) ();
  };
  var $T17 = function () {
    return ($T17 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm06.Fusee.Jometri.DCEL.PolyBoundary))) ();
  };
  var $T18 = function () {
    return ($T18 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerator$b1.Of($asm06.Fusee.Jometri.DCEL.PolyBoundary))) ();
  };
  var $T19 = function () {
    return ($T19 = JSIL.Memoize($asm0E.System.Collections.IEnumerator)) ();
  };
  var $T1A = function () {
    return ($T1A = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerator$b1.Of($asm06.Fusee.Jometri.DCEL.InitializeGeometryHelper_BoundaryEdge))) ();
  };
  var $T1B = function () {
    return ($T1B = JSIL.Memoize($asm0E.System.IDisposable)) ();
  };
  var $T1C = function () {
    return ($T1C = JSIL.Memoize($asm07.Fusee.Math.Core.float3)) ();
  };
  var $T1D = function () {
    return ($T1D = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerator$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex))) ();
  };
  var $T1E = function () {
    return ($T1E = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex))) ();
  };
  var $T1F = function () {
    return ($T1F = JSIL.Memoize($asm0E.System.ArgumentException)) ();
  };
  var $T20 = function () {
    return ($T20 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerator$b1.Of($asm07.Fusee.Math.Core.float3))) ();
  };
  var $T21 = function () {
    return ($T21 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm07.Fusee.Math.Core.float3))) ();
  };
  var $T22 = function () {
    return ($T22 = JSIL.Memoize($asm0E.System.Collections.Generic.IList$b1.Of($asm06.Fusee.Jometri.DCEL.InitializeGeometryHelper_BoundaryEdge))) ();
  };
  var $T23 = function () {
    return ($T23 = JSIL.Memoize($asm0E.System.Collections.Generic.ICollection$b1.Of($asm06.Fusee.Jometri.DCEL.InitializeGeometryHelper_BoundaryEdge))) ();
  };
  var $T24 = function () {
    return ($T24 = JSIL.Memoize($asm0E.System.Collections.Generic.ICollection$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge))) ();
  };
  var $S00 = function () {
    return ($S00 = JSIL.Memoize(new JSIL.ConstructorSignature($asm06.Fusee.Jometri.DCEL.Face, [$asm0E.System.Int32, $asm0E.System.Int32]))) ();
  };
  var $S01 = function () {
    return ($S01 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.List$b1.Of($asm06.Fusee.Jometri.DCEL.InitializeGeometryHelper_BoundaryEdge), null))) ();
  };
  var $S02 = function () {
  ...
  var $S05 = function () {
    return ($S05 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.List$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge), null))) ();
  };
  var $S06 = function () {
    return ($S06 = JSIL.Memoize(new JSIL.MethodSignature(null, [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")]))) ();
  };
  var $S07 = function () {
    return ($S07 = JSIL.Memoize(new JSIL.ConstructorSignature($asm06.Fusee.Jometri.DCEL.Face, [$asm0E.System.Int32]))) ();
  };
  var $S08 = function () {
    return ($S08 = JSIL.Memoize(new JSIL.MethodSignature(null, [$asm0E.System.Int32, $asm07.Fusee.Math.Core.float3]))) ();
  };
  var $S09 = function () {
    return ($S09 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.ArgumentException, [$asm0E.System.String]))) ();
  };
  var $S0A = function () {
    return ($S0A = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.List$b1.Of($asm0E.System.Collections.Generic.KeyValuePair$b2.Of($asm06.Fusee.Jometri.DCEL.Vertex, $asm0E.System.Boolean)), null))) ();
  };
  var $S0B = function () {
    return ($S0B = JSIL.Memoize(new JSIL.MethodSignature(null, [$asm0E.TypeRef("System.Collections.Generic.KeyValuePair`2", [$asm06.TypeRef("Fusee.Jometri.DCEL.Vertex"), $asm0E.TypeRef("System.Boolean")])]))) ();
  };
  var $IM00 = function () {
    return ($IM00 = JSIL.Memoize($asm0E.System.Collections.Generic.ICollection$b1.Of($asm0E.System.Collections.Generic.KeyValuePair$b2.Of($asm06.Fusee.Jometri.DCEL.Vertex, $asm0E.System.Boolean)).get_Count)) ();
  };
  var $IM01 = function () {
    return ($IM01 = JSIL.Memoize($asm0E.System.Collections.Generic.IList$b1.Of($asm0E.System.Collections.Generic.KeyValuePair$b2.Of($asm06.Fusee.Jometri.DCEL.Vertex, $asm0E.System.Boolean)).get_Item)) ();
  };
  var $IM02 = function () {
    return ($IM02 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm06.Fusee.Jometri.DCEL.PolyBoundary).GetEnumerator)) ();
  };
  var $IM03 = function () {
    return ($IM03 = JSIL.Memoize($asm0E.System.Collections.IEnumerator.MoveNext)) ();
  };
  var $IM04 = function () {
    return ($IM04 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerator$b1.Of($asm06.Fusee.Jometri.DCEL.PolyBoundary).get_Current)) ();
  };
  var $IM05 = function () {
    return ($IM05 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm06.Fusee.Jometri.DCEL.InitializeGeometryHelper_BoundaryEdge).GetEnumerator)) ();
  };
  var $IM06 = function () {
    return ($IM06 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerator$b1.Of($asm06.Fusee.Jometri.DCEL.InitializeGeometryHelper_BoundaryEdge).get_Current)) ();
  };
  var $IM07 = function () {
  ...
  var $IM0A = function () {
    return ($IM0A = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm07.Fusee.Math.Core.float3).GetEnumerator)) ();
  };
  var $IM0B = function () {
    return ($IM0B = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerator$b1.Of($asm07.Fusee.Math.Core.float3).get_Current)) ();
  };
  var $IM0C = function () {
    return ($IM0C = JSIL.Memoize($asm0E.System.Collections.Generic.ICollection$b1.Of($asm06.Fusee.Jometri.DCEL.InitializeGeometryHelper_BoundaryEdge).get_Count)) ();
  };
  var $IM0D = function () {
    return ($IM0D = JSIL.Memoize($asm0E.System.Collections.Generic.IList$b1.Of($asm06.Fusee.Jometri.DCEL.InitializeGeometryHelper_BoundaryEdge).get_Item)) ();
  };
  var $IM0E = function () {
    return ($IM0E = JSIL.Memoize($asm0E.System.Collections.Generic.IList$b1.Of($asm06.Fusee.Jometri.DCEL.InitializeGeometryHelper_BoundaryEdge).set_Item)) ();
  };
  var $IM0F = function () {
    return ($IM0F = JSIL.Memoize($asm0E.System.Collections.Generic.ICollection$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge).Add)) ();
  };
  ...
  function InitializeGeometryHelper_BoundaryEdges (outlineVerts, polyBoundary) {
    ...
    for (var i = 0; i < ($IM00().Call(outlineVerts, null) | 0); i = ((i + 1) | 0)) {
      ...
      if (isOuter) {
        ...
        faceHandle = ($T12().LastItem$b1($T11())($thisType._geometry.Geometry$DictFaces$value).get_Value().Handle | 0);
      }
      ...
      $S04().CallVirtual("Add", null, boundaryEdges, boundaryEdge.MemberwiseClone());
    }
  ...
  function InitializeGeometryHelper_CreateHalfEdgesForBoundary (outline) {
    ...
    var halfEdgesToUpdate = $S05().Construct();
    ...
    for (var i = (((boundaryEdges.get_Count() | 0) - 1) | 0); i > -1; i = ((i - 1) | 0)) {
      ...
      if (!flag) {
        ...
        $loop1: 
          ...
          $S06().CallVirtual("Add", null, halfEdgesToUpdate, existingHe.MemberwiseClone());
  ...
  function InitializeGeometryHelper_CreateHalfEdgesForGeometry (geometry, outlines) {
    $thisType._geometry = geometry;
    var unboundedFace = $S07().Construct(((((geometry.Geometry$DictHalfEdges$value).get_Count() | 0) + 1) | 0));
  ...
  function InitializeGeometryHelper_CreateOrFindVertex (pointCoord, /* ref */ isOldVertex, handle) {
    ...
    if (flag) {
      ...
      (vert = vert.MemberwiseClone(), 
        $S08().Call($T0D().prototype, "_ctor", null, vert, handle, pointCoord.MemberwiseClone()));
    } else {
      (vert = vert.MemberwiseClone(), 
        $S08().Call($T0D().prototype, "_ctor", null, vert, handle, pointCoord.MemberwiseClone()));
    }
  ...
  function InitializeGeometryHelper_OutlineVertices (polyBoundary) {
    ...
    var outlineVerts = $S0A().Construct();
    var handle = 0;
    var flag = ($thisType._geometry.Geometry$DictVertices$value.get_Count() >>> 0) > (0 >>> 0);
    if (flag) {
    ...
    try {
      ...
      while ($IM03().Call(enumerator, null)) {
        ...
        $S0B().CallVirtual("Add", null, outlineVerts, new ($T0C())(vert.MemberwiseClone(), isOldVert.get()));
      }
    } finally {
      if (enumerator !== null) {
        $IM07().Call(enumerator, null);
  ...
  function InitializeGeometryHelper_SetPrevAndNextForBoundary (boundaryEdges) {
    ...
    for (var i = 0; i < ($IM0C().Call(boundaryEdges, null) | 0); i = ((i + 1) | 0)) {
      ...
      var flag = ((i - 1) | 0) < 0;
      if (flag) {
        halfEdge.PrevHalfEdge = ($T12().LastItem$b1($T13())(boundaryEdges).HalfEdge.Handle | 0);
        twinHalfEdge.NextHalfEdge = ($T12().LastItem$b1($T13())(boundaryEdges).TwinHalfEdge.Handle | 0);
      } else {
  ...
  JSIL.MakeStaticClass("Fusee.Jometri.DCEL.InitializeGeometryHelper", true, [], function ($ib) {
    ...
    $.Method({Static:true , Public:false}, "BoundaryEdges", 
      new JSIL.MethodSignature($asm0E.TypeRef("System.Collections.Generic.List`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.InitializeGeometryHelper+BoundaryEdge")]), [$asm0E.TypeRef("System.Collections.Generic.IList`1", [$asm0E.TypeRef("System.Collections.Generic.KeyValuePair`2", [$asm06.TypeRef("Fusee.Jometri.DCEL.Vertex"), $.Boolean])]), $asm06.TypeRef("Fusee.Jometri.DCEL.PolyBoundary")]), 
      InitializeGeometryHelper_BoundaryEdges
    );

    $.Method({Static:true , Public:false}, "CreateHalfEdgesForBoundary", 
      new JSIL.MethodSignature($asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.InitializeGeometryHelper+BoundaryEdge")]), [$asm06.TypeRef("Fusee.Jometri.DCEL.PolyBoundary")]), 
      InitializeGeometryHelper_CreateHalfEdgesForBoundary
    );

    $.Method({Static:true , Public:false}, "CreateHalfEdgesForGeometry", 
      new JSIL.MethodSignature(null, [$asm06.TypeRef("Fusee.Jometri.DCEL.Geometry"), $asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.PolyBoundary")])]), 
    ...
    $.Method({Static:true , Public:false}, "IsEdgeExisting", 
      new JSIL.MethodSignature($.Boolean, [
          $asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge"), $asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.InitializeGeometryHelper+BoundaryEdge")]), 
    ...
    $.Method({Static:true , Public:false}, "OutlineVertices", 
      new JSIL.MethodSignature($asm0E.TypeRef("System.Collections.Generic.List`1", [$asm0E.TypeRef("System.Collections.Generic.KeyValuePair`2", [$asm06.TypeRef("Fusee.Jometri.DCEL.Vertex"), $.Boolean])]), [$asm06.TypeRef("Fusee.Jometri.DCEL.PolyBoundary")]), 
      InitializeGeometryHelper_OutlineVertices
    );

    $.Method({Static:true , Public:false}, "SetPrevAndNextForBoundary", 
      JSIL.MethodSignature.Action($asm0E.TypeRef("System.Collections.Generic.IList`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.InitializeGeometryHelper+BoundaryEdge")])), 
    ...
    $.Method({Static:true , Public:false}, "SetPrevAndNextToExistingHalfEdge", 
      new JSIL.MethodSignature(null, [
          ...
          $asm0E.TypeRef("System.Collections.Generic.IList`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.InitializeGeometryHelper+BoundaryEdge")]), $asm0E.TypeRef("System.Collections.Generic.ICollection`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")])
        ]), 
...
(function Geometry$Members () {
  var $, $thisType;
  var $T00 = function () {
    return ($T00 = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm06.Fusee.Jometri.DCEL.Face, $asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm07.Fusee.Math.Core.float3)))) ();
  };
  var $T01 = function () {
    return ($T01 = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Vertex))) ();
  };
  var $T02 = function () {
    return ($T02 = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.HalfEdge))) ();
  };
  var $T03 = function () {
    return ($T03 = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Face))) ();
  };
  var $T04 = function () {
    return ($T04 = JSIL.Memoize($asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm06.Fusee.Jometri.DCEL.PolyBoundary))) ();
  };
  var $T05 = function () {
  ...
  var $T0E = function () {
    return ($T0E = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2_Enumerator.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Face))) ();
  };
  var $T0F = function () {
    return ($T0F = JSIL.Memoize($asm0E.System.Collections.Generic.KeyValuePair$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Face))) ();
  };
  var $T10 = function () {
    return ($T10 = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm07.Fusee.Math.Core.float3))) ();
  };
  var $T11 = function () {
  ...
  var $T15 = function () {
    return ($T15 = JSIL.Memoize($asm0E.System.ArgumentException)) ();
  };
  var $T16 = function () {
    return ($T16 = JSIL.Memoize($asm0E.System.String)) ();
  };
  var $T17 = function () {
  ...
  var $T1B = function () {
    return ($T1B = JSIL.Memoize($asm0E.System.Collections.Generic.List$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge))) ();
  };
  var $T1C = function () {
    return ($T1C = JSIL.Memoize($asm0E.System.Func$b2.Of($asm06.Fusee.Jometri.DCEL.HalfEdge, $asm0E.System.Boolean))) ();
  };
  var $T1D = function () {
  ...
  var $T1F = function () {
    return ($T1F = JSIL.Memoize($asm06.Fusee.Jometri.DCEL.Geometry_$lGetFaceVertices$gd__45)) ();
  };
  var $T20 = function () {
    return ($T20 = JSIL.Memoize($asm06.Fusee.Jometri.DCEL.Geometry_$lGetHalfEdgeLoop$gd__42)) ();
  };
  var $T21 = function () {
    return ($T21 = JSIL.Memoize($asm06.Fusee.Jometri.DCEL.Geometry_$lGetHalfEdgeLoopReverse$gd__43)) ();
  };
  var $T22 = function () {
    return ($T22 = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm0E.System.Collections.Generic.List$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge)))) ();
  };
  var $T23 = function () {
    return ($T23 = JSIL.Memoize($asm06.Fusee.Jometri.DCEL.Geometry_$lGetVertexAdajacentFaces$gd__37)) ();
  };
  var $T24 = function () {
    return ($T24 = JSIL.Memoize($asm06.Fusee.Jometri.DCEL.Geometry_$lGetVertexAdjacentVertices$gd__36)) ();
  };
  var $T25 = function () {
    return ($T25 = JSIL.Memoize($asm06.Fusee.Jometri.DCEL.Geometry_$lGetVertexIncidentHalfEdges$gd__38)) ();
  };
  var $T26 = function () {
    return ($T26 = JSIL.Memoize($asm06.Fusee.Jometri.DCEL.Geometry_$lGetVertexStartingHalfEdges$gd__39)) ();
  };
  var $T27 = function () {
    return ($T27 = JSIL.Memoize($asm06.Fusee.Jometri.DCEL.Geometry_$lGetVertexTargetingHalfEdges$gd__40)) ();
  };
  var $T28 = function () {
    return ($T28 = JSIL.Memoize($asm06.Fusee.Jometri.DCEL.FaceData)) ();
  };
  var $T29 = function () {
    return ($T29 = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2_Enumerator.Of($asm0E.System.Int32, $asm0E.System.Collections.Generic.List$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge)))) ();
  };
  var $T2A = function () {
    return ($T2A = JSIL.Memoize($asm0E.System.Collections.Generic.KeyValuePair$b2.Of($asm0E.System.Int32, $asm0E.System.Collections.Generic.List$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge)))) ();
  };
  var $T2B = function () {
    return ($T2B = JSIL.Memoize($asm0E.System.Collections.Generic.IList$b1.Of($asm06.Fusee.Jometri.DCEL.Vertex))) ();
  };
  var $S00 = function () {
    return ($S00 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm06.Fusee.Jometri.DCEL.Face, $asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm07.Fusee.Math.Core.float3)), null))) ();
  };
  var $S01 = function () {
    return ($S01 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Vertex), null))) ();
  };
  var $S02 = function () {
    return ($S02 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.HalfEdge), null))) ();
  };
  var $S03 = function () {
    return ($S03 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Face), null))) ();
  };
  var $S04 = function () {
  ...
  var $S05 = function () {
    return ($S05 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.List$b1.Of($asm0E.System.Int32), null))) ();
  };
  var $S06 = function () {
    return ($S06 = JSIL.Memoize(new JSIL.MethodSignature($asm0E.System.Boolean, [
        $asm06.Fusee.Jometri.DCEL.Geometry, $asm06.Fusee.Jometri.DCEL.Face, 
        $asm06.Fusee.Jometri.DCEL.Vertex
      ]))) ();
  };
  var $S07 = function () {
    return ($S07 = JSIL.Memoize(new JSIL.MethodSignature(null, [$asm0E.TypeRef("System.Int32")]))) ();
  };
  var $S08 = function () {
    return ($S08 = JSIL.Memoize(new JSIL.ConstructorSignature($asm06.Fusee.Jometri.DCEL.Geometry, null))) ();
  };
  var $S09 = function () {
    return ($S09 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Vertex), [$asm0E.TypeRef("System.Collections.Generic.IDictionary`2", [$asm0E.TypeRef("System.Int32"), $asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")])]))) ();
  };
  var $S0A = function () {
    return ($S0A = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.HalfEdge), [$asm0E.TypeRef("System.Collections.Generic.IDictionary`2", [$asm0E.TypeRef("System.Int32"), $asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")])]))) ();
  };
  var $S0B = function () {
    return ($S0B = JSIL.Memoize(new JSIL.MethodSignature(null, [$asm0E.System.Int32, $asm0E.System.Int32]))) ();
  };
  var $S0C = function () {
    return ($S0C = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm07.Fusee.Math.Core.float3), null))) ();
  };
  var $S0D = function () {
    return ($S0D = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.ArgumentException, [$asm0E.System.String]))) ();
  };
  var $S0E = function () {
    return ($S0E = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.List$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge), [$asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")])]))) ();
  };
  var $S0F = function () {
  ...
  var $S10 = function () {
    return ($S10 = JSIL.Memoize(new JSIL.MethodSignature($asm0E.System.Boolean, [$asm06.Fusee.Jometri.DCEL.HalfEdge]))) ();
  };
  var $S11 = function () {
    return ($S11 = JSIL.Memoize(new JSIL.MethodSignature($asm0E.System.Boolean, [$asm06.Fusee.Jometri.DCEL.HalfEdge]))) ();
  };
  var $S12 = function () {
    return ($S12 = JSIL.Memoize(new JSIL.MethodSignature($asm07.Fusee.Math.Core.float3, [$asm0E.System.Single, $asm07.Fusee.Math.Core.float3]))) ();
  };
  var $S13 = function () {
    return ($S13 = JSIL.Memoize(new JSIL.MethodSignature($asm0E.System.Boolean, [
        $asm06.Fusee.Jometri.DCEL.Geometry, $asm06.Fusee.Jometri.DCEL.Face, 
        $asm07.Fusee.Math.Core.float3
      ]))) ();
  };
  var $S14 = function () {
    return ($S14 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm0E.System.Collections.Generic.List$b1.Of($asm06.Fusee.Jometri.DCEL.HalfEdge)), null))) ();
  };
  var $S15 = function () {
    return ($S15 = JSIL.Memoize(new JSIL.ConstructorSignature($asm06.Fusee.Jometri.DCEL.HalfEdge, [$asm0E.System.Int32]))) ();
  };
  var $S16 = function () {
    return ($S16 = JSIL.Memoize(new JSIL.MethodSignature($asm0E.System.Int32, [$asm0E.System.Collections.Generic.IEnumerable$b1.Of($asm0E.System.Int32)]))) ();
  };
  ...
  function Geometry_AssignFaceHandle (heHandle, newFace) {
    var $temp00;
    var oldFaceHandle = (this.GetHalfEdgeByHandle(heHandle).IncidentFace | 0);
    var currentHe = this.GetHalfEdgeByHandle(heHandle).MemberwiseClone();

    do {
      currentHe.IncidentFace = (newFace.Handle | 0);
      (this.Geometry$DictHalfEdges$value).set_Item(currentHe.Handle, currentHe.MemberwiseClone());
      currentHe = this.GetHalfEdgeByHandle(currentHe.NextHalfEdge).MemberwiseClone();
    } while ((currentHe.Handle | 0) !== (heHandle | 0));
    var oldFace = this.GetFaceByHandle(oldFaceHandle).MemberwiseClone();
    var flag = ((oldFace.InnerHalfEdges).get_Count() | 0) === 0;
    if (!flag) {
      var inner = $S05().Construct();
      ...
      for (var a$0 = inner._items, i$0 = 0, l$0 = (inner._size | 0); i$0 < l$0; ($temp00 = i$0, 
          ...
          $temp00)) {
        var heh = a$0[i$0];
        var origin = (this.GetHalfEdgeByHandle(heh).OriginVertex | 0);
        var flag2 = !$S06().CallStatic($T0D(), "IsPointInPolygon", null, this, newFace.MemberwiseClone(), this.GetVertexByHandle(origin).MemberwiseClone());
        if (!flag2) {
          (oldFace.InnerHalfEdges).Remove(heh);
          $S07().CallVirtual("Add", null, newFace.InnerHalfEdges, heh);
          var curHe = this.GetHalfEdgeByHandle(heh).MemberwiseClone();

          do {
            curHe.IncidentFace = (newFace.Handle | 0);
            (this.Geometry$DictHalfEdges$value).set_Item(curHe.Handle, curHe.MemberwiseClone());
            curHe = this.GetHalfEdgeByHandle(curHe.NextHalfEdge).MemberwiseClone();
  ...
  function Geometry_CloneGeometry () {
    ...
    while ($T0E().prototype.MoveNext.call(enumerator)) {
      var f = $T0E().prototype.get_Current.call(enumerator);
      var oldFace = f.get_Value().MemberwiseClone();
      (face = face.MemberwiseClone(), 
        $S0B().Call($T0A().prototype, "_ctor", null, face, oldFace.Handle, oldFace.OuterHalfEdge));
  ...
  function Geometry_Get2DVertPos (face, vertHandle) {
    ...
    var pos = new JSIL.BoxedVariable(new ($T11())());
    ...
    if (flag) {
      ...
      if (flag2) {
        ...
        pos.set($T0D().Reduce2D(vertex.VertData.Pos, face.FaceData.FaceNormal.MemberwiseClone()).MemberwiseClone());
      ...
      pos.set($T0D().Reduce2D(vert.VertData.Pos, face.FaceData.FaceNormal.MemberwiseClone()).MemberwiseClone());
  ...
  function Geometry_GetFaceToInsertDiag (p, q, /* ref */ pStartHe, /* ref */ qStartHe) {
    ...
    var heWithSameFaceQ = $S0E().Construct($S0F().CallStatic($T09(), "Where$b1", [$asm06.Fusee.Jometri.DCEL.HalfEdge], $closure0.heStartingAtQ, $T1C().New($closure0, null, new JSIL.MethodPointerInfo($asm06.Fusee.Jometri.DCEL.Geometry_$l$gc__DisplayClass59_0, "$lGetFaceToInsertDiag$gb__0", $S10(), false, false))));
    var heWithSameFaceP = $S0E().Construct($S0F().CallStatic($T09(), "Where$b1", [$asm06.Fusee.Jometri.DCEL.HalfEdge], $closure0.heStartingAtP, $T1C().New($closure0, null, new JSIL.MethodPointerInfo($asm06.Fusee.Jometri.DCEL.Geometry_$l$gc__DisplayClass59_0, "$lGetFaceToInsertDiag$gb__2", $S11(), false, false))));
    var flag = (heWithSameFaceP.get_Count() | 0) === 1;
    if (!flag) {

      for (var i = 0; i < (heWithSameFaceP.get_Count() | 0); i = ((i + 1) | 0)) {
        var he = heWithSameFaceP.get_Item(i).MemberwiseClone();
        var face = this.GetFaceByHandle(he.IncidentFace).MemberwiseClone();
        var flag2 = (face.Handle | 0) === 1;
        if (!flag2) {
          var diagMiddPoint = $T11().op_Addition(
            $S12().CallStatic($T11(), "op_Multiply", null, 0.5, vertP.VertData.Pos.MemberwiseClone()).MemberwiseClone(), 
            $S12().CallStatic($T11(), "op_Multiply", null, 0.5, vertQ.VertData.Pos.MemberwiseClone())
          );
          var redMidd = $T0D().Reduce2D(diagMiddPoint, face.FaceData.FaceNormal.MemberwiseClone());
          var flag3 = !$S13().CallStatic($T0D(), "IsPointInPolygon", null, this, face.MemberwiseClone(), redMidd);
          if (!flag3) {
            ...
            for (var a$1 = heWithSameFaceQ._items, i$1 = 0, l$1 = (heWithSameFaceQ._size | 0); i$1 < l$1; ($temp01 = i$1, 
                i$1 = ((i$1 + 1) | 0), 
                $temp01)) {
              var heQ = a$1[i$1];
      ...
      throw $S0D().Construct(JSIL.ConcatString.apply(null, JSIL.Array.New($T1D(), ["Vertex ", $T07().$Box(p), " vertex ", $T07().$Box(q), " have no common Face!"])));
    }
  ...
  function Geometry_InsertDiagonal (p, q) {
    var newFace = new ($T0A())();
    var pStartHe = new JSIL.BoxedVariable(new ($T0B())());
    var qStartHe = new JSIL.BoxedVariable(new ($T0B())());
    var face = this.GetFaceToInsertDiag(p, q, /* ref */ pStartHe, /* ref */ qStartHe).MemberwiseClone();
    ...
    var newFromP = $S15().Construct(this.CreateHalfEdgeHandleId());
    var newFromQ = $S15().Construct(this.CreateHalfEdgeHandleId());
    ...
    (this.Geometry$DictHalfEdges$value).Add(newFromP.Handle, newFromP.MemberwiseClone());
    (this.Geometry$DictHalfEdges$value).Add(newFromQ.Handle, newFromQ.MemberwiseClone());
    var prevHeP = this.GetHalfEdgeByHandle(pStartHe.get().PrevHalfEdge).MemberwiseClone();
    var prevHeQ = this.GetHalfEdgeByHandle(qStartHe.get().PrevHalfEdge).MemberwiseClone();
    var prevHePUpdate = (this.Geometry$DictHalfEdges$value).get_Item(prevHeP.Handle).MemberwiseClone();
    prevHePUpdate.NextHalfEdge = (newFromP.Handle | 0);
    (this.Geometry$DictHalfEdges$value).set_Item(prevHeP.Handle, prevHePUpdate.MemberwiseClone());
    var prevHeQUpdate = (this.Geometry$DictHalfEdges$value).get_Item(prevHeQ.Handle).MemberwiseClone();
    prevHeQUpdate.NextHalfEdge = (newFromQ.Handle | 0);
    (this.Geometry$DictHalfEdges$value).set_Item(prevHeQ.Handle, prevHeQUpdate.MemberwiseClone());
    var nextHePUpdate = (this.Geometry$DictHalfEdges$value).get_Item(pStartHe.get().Handle).MemberwiseClone();
    nextHePUpdate.PrevHalfEdge = (newFromQ.Handle | 0);
    (this.Geometry$DictHalfEdges$value).set_Item(pStartHe.get().Handle, nextHePUpdate.MemberwiseClone());
    var nextHeQUpdate = (this.Geometry$DictHalfEdges$value).get_Item(qStartHe.get().Handle).MemberwiseClone();
    nextHeQUpdate.PrevHalfEdge = (newFromP.Handle | 0);
    (this.Geometry$DictHalfEdges$value).set_Item(qStartHe.get().Handle, nextHeQUpdate.MemberwiseClone());
    var holes = this.GetHoles(face);
    var flag2 = ((holes.get_Count() | 0) !== 0) && 
    $thisType.IsNewEdgeToHole(holes, p, q, face.MemberwiseClone());
    if (!flag2) {
      (newFace = newFace.MemberwiseClone(), 
        $S0B().Call($T0A().prototype, "_ctor", null, newFace, this.CreateFaceHandleId(), newFromQ.Handle));
      ...
      (this.Geometry$DictFaces$value).Add(newFace.Handle, newFace.MemberwiseClone());
      this.AssignFaceHandle(newFace.OuterHalfEdge, newFace.MemberwiseClone());
  ...
  function Geometry_IsNewEdgeToHole (holes, pHandle, qHandle, face) {
    ...
    if (flag) {
      ...
      var enumerator = $T22().prototype.GetEnumerator.call(holes);

      while ($T29().prototype.MoveNext.call(enumerator)) {
        var hole = $T29().prototype.get_Current.call(enumerator).MemberwiseClone();
  ...
  function Geometry_SetFaceNormal (faceOuterVertices, face) {
    var normal = $T0D().CalculateFaceNormal(faceOuterVertices);
  ...
  function Geometry_SetHighestHandles () {
    this.Geometry$HighestVertHandle$value = ($S16().CallStatic($T09(), "Max", null, (this.Geometry$DictVertices$value).get_Keys()) | 0);
    this.Geometry$HighestHalfEdgeHandle$value = ($S16().CallStatic($T09(), "Max", null, (this.Geometry$DictHalfEdges$value).get_Keys()) | 0);
    this.Geometry$HighestFaceHandle$value = ($S16().CallStatic($T09(), "Max", null, (this.Geometry$DictFaces$value).get_Keys()) | 0);
  }; 
  ...
  JSIL.MakeType({
    ...
    $.Method({Static:false, Public:true }, ".ctor", 
      JSIL.MethodSignature.Action($asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.PolyBoundary")])), 
      Geometry__ctor$01
    );
    ...
    $.Method({Static:false, Public:false}, "get_DictFaces", 
      JSIL.MethodSignature.Return($asm0E.TypeRef("System.Collections.Generic.Dictionary`2", [$.Int32, $asm06.TypeRef("Fusee.Jometri.DCEL.Face")])), 
      Geometry_get_DictFaces
    )
      .Attribute($asm0E.TypeRef("System.Runtime.CompilerServices.CompilerGeneratedAttribute"));

    $.Method({Static:false, Public:false}, "get_DictHalfEdges", 
      JSIL.MethodSignature.Return($asm0E.TypeRef("System.Collections.Generic.Dictionary`2", [$.Int32, $asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")])), 
      Geometry_get_DictHalfEdges
    )
      .Attribute($asm0E.TypeRef("System.Runtime.CompilerServices.CompilerGeneratedAttribute"));

    $.Method({Static:false, Public:false}, "get_DictVertices", 
      JSIL.MethodSignature.Return($asm0E.TypeRef("System.Collections.Generic.Dictionary`2", [$.Int32, $asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")])), 
    ...
    $.Method({Static:false, Public:true }, "GetAllFaces", 
      JSIL.MethodSignature.Return($asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Face")])), 
      Geometry_GetAllFaces
    );

    $.Method({Static:false, Public:true }, "GetAllHalfEdges", 
      JSIL.MethodSignature.Return($asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")])), 
      Geometry_GetAllHalfEdges
    );

    $.Method({Static:false, Public:true }, "GetAllVertices", 
      JSIL.MethodSignature.Return($asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")])), 
    ...
    $.Method({Static:false, Public:true }, "GetFaceHalfEdges", 
      new JSIL.MethodSignature($asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")]), [$.Int32]), 
      Geometry_GetFaceHalfEdges
    );

    $.Method({Static:false, Public:true }, "GetFaceOuterVertices", 
      new JSIL.MethodSignature($asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")]), [$.Int32]), 
      Geometry_GetFaceOuterVertices
    );

    $.Method({Static:false, Public:true }, "GetFacesAdajacentToFace", 
      new JSIL.MethodSignature($asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Face")]), [$.Int32]), 
    ...
    $.Method({Static:false, Public:false}, "GetHoles", 
      new JSIL.MethodSignature($asm0E.TypeRef("System.Collections.Generic.Dictionary`2", [$.Int32, $asm0E.TypeRef("System.Collections.Generic.List`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")])]), [$asm06.TypeRef("Fusee.Jometri.DCEL.Face")]), 
      Geometry_GetHoles
    );
    ...
    $.Method({Static:true , Public:false}, "IsNewEdgeToHole", 
      new JSIL.MethodSignature($.Boolean, [
          $asm0E.TypeRef("System.Collections.Generic.Dictionary`2", [$.Int32, $asm0E.TypeRef("System.Collections.Generic.List`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")])]), $.Int32, 
    ...
    $.Method({Static:false, Public:false}, "set_DictFaces", 
      JSIL.MethodSignature.Action($asm0E.TypeRef("System.Collections.Generic.Dictionary`2", [$.Int32, $asm06.TypeRef("Fusee.Jometri.DCEL.Face")])), 
      Geometry_set_DictFaces
    )
      .Attribute($asm0E.TypeRef("System.Runtime.CompilerServices.CompilerGeneratedAttribute"));

    $.Method({Static:false, Public:false}, "set_DictHalfEdges", 
      JSIL.MethodSignature.Action($asm0E.TypeRef("System.Collections.Generic.Dictionary`2", [$.Int32, $asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")])), 
      Geometry_set_DictHalfEdges
    )
      .Attribute($asm0E.TypeRef("System.Runtime.CompilerServices.CompilerGeneratedAttribute"));

    $.Method({Static:false, Public:false}, "set_DictVertices", 
      JSIL.MethodSignature.Action($asm0E.TypeRef("System.Collections.Generic.Dictionary`2", [$.Int32, $asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")])), 
    ...
    $.Method({Static:false, Public:true }, "SetFaceNormal", 
      new JSIL.MethodSignature(null, [$asm0E.TypeRef("System.Collections.Generic.IList`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")]), $asm06.TypeRef("Fusee.Jometri.DCEL.Face")]), 
    ...
    $.Field({Static:false, Public:false, ReadOnly:true }, "_vertPos2DCache", $asm0E.TypeRef("System.Collections.Generic.Dictionary`2", [$asm06.TypeRef("Fusee.Jometri.DCEL.Face"), $asm0E.TypeRef("System.Collections.Generic.Dictionary`2", [$.Int32, $asm07.TypeRef("Fusee.Math.Core.float3")])]));

    $.Field({Static:false, Public:false}, "Geometry$DictVertices$value", $asm0E.TypeRef("System.Collections.Generic.Dictionary`2", [$.Int32, $asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")]))
      .Attribute($asm0E.TypeRef("System.Runtime.CompilerServices.CompilerGeneratedAttribute"))
      .Attribute($asm0E.TypeRef("System.Diagnostics.DebuggerBrowsableAttribute"), function () { return [$asm0E.System.Diagnostics.DebuggerBrowsableState.Never]; });

    $.Field({Static:false, Public:false}, "Geometry$DictHalfEdges$value", $asm0E.TypeRef("System.Collections.Generic.Dictionary`2", [$.Int32, $asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")]))
      .Attribute($asm0E.TypeRef("System.Runtime.CompilerServices.CompilerGeneratedAttribute"))
      .Attribute($asm0E.TypeRef("System.Diagnostics.DebuggerBrowsableAttribute"), function () { return [$asm0E.System.Diagnostics.DebuggerBrowsableState.Never]; });

    $.Field({Static:false, Public:false}, "Geometry$DictFaces$value", $asm0E.TypeRef("System.Collections.Generic.Dictionary`2", [$.Int32, $asm06.TypeRef("Fusee.Jometri.DCEL.Face")]))
      .Attribute($asm0E.TypeRef("System.Runtime.CompilerServices.CompilerGeneratedAttribute"))
      .Attribute($asm0E.TypeRef("System.Diagnostics.DebuggerBrowsableAttribute"), function () { return [$asm0E.System.Diagnostics.DebuggerBrowsableState.Never]; });
    ...
    $.Property({Static:false, Public:false}, "DictVertices", $asm0E.TypeRef("System.Collections.Generic.Dictionary`2", [$.Int32, $asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")]));

    $.Property({Static:false, Public:false}, "DictHalfEdges", $asm0E.TypeRef("System.Collections.Generic.Dictionary`2", [$.Int32, $asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")]));

    $.Property({Static:false, Public:false}, "DictFaces", $asm0E.TypeRef("System.Collections.Generic.Dictionary`2", [$.Int32, $asm06.TypeRef("Fusee.Jometri.DCEL.Face")]));
...
(function $lGetAllVertices$gd__33$Members () {
  ...
  var $T05 = function () {
    return ($T05 = JSIL.Memoize($asm0E.System.Collections.Generic.KeyValuePair$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Vertex))) ();
  };
  var $T06 = function () {
    return ($T06 = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Vertex))) ();
  };
  ...
  var $T08 = function () {
    return ($T08 = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2_Enumerator.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Vertex))) ();
  };
  var $T09 = function () {
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:false}, "$l$gs__1", $asm0E.TypeRef("System.Collections.Generic.Dictionary`2+Enumerator", [$.Int32, $asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")]));

    $.Field({Static:false, Public:false}, "$lvert$g5__2", $asm0E.TypeRef("System.Collections.Generic.KeyValuePair`2", [$.Int32, $asm06.TypeRef("Fusee.Jometri.DCEL.Vertex")]));
...
(function $lGetAllHalfEdges$gd__34$Members () {
  ...
  var $T05 = function () {
    return ($T05 = JSIL.Memoize($asm0E.System.Collections.Generic.KeyValuePair$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.HalfEdge))) ();
  };
  var $T06 = function () {
    return ($T06 = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.HalfEdge))) ();
  };
  var $T07 = function () {
    return ($T07 = JSIL.Memoize($asm06.Fusee.Jometri.DCEL.Geometry)) ();
  };
  var $T08 = function () {
    return ($T08 = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2_Enumerator.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.HalfEdge))) ();
  };
  var $T09 = function () {
    return ($T09 = JSIL.Memoize($asm0E.System.NotSupportedException)) ();
  };
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:false}, "$l$gs__1", $asm0E.TypeRef("System.Collections.Generic.Dictionary`2+Enumerator", [$.Int32, $asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")]));

    $.Field({Static:false, Public:false}, "$lhe$g5__2", $asm0E.TypeRef("System.Collections.Generic.KeyValuePair`2", [$.Int32, $asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")]));
...
(function $lGetAllFaces$gd__35$Members () {
  ...
  var $T05 = function () {
    return ($T05 = JSIL.Memoize($asm0E.System.Collections.Generic.KeyValuePair$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Face))) ();
  };
  var $T06 = function () {
    return ($T06 = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Face))) ();
  };
  var $T07 = function () {
    return ($T07 = JSIL.Memoize($asm06.Fusee.Jometri.DCEL.Geometry)) ();
  };
  var $T08 = function () {
    return ($T08 = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2_Enumerator.Of($asm0E.System.Int32, $asm06.Fusee.Jometri.DCEL.Face))) ();
  };
  var $T09 = function () {
    return ($T09 = JSIL.Memoize($asm0E.System.NotSupportedException)) ();
  };
  ...
  JSIL.MakeType({
    ...
    $.Method({Static:false, Public:false, Virtual:true }, "System.Collections.Generic.IEnumerable$lFusee.Jometri.DCEL.Face$g.GetEnumerator", 
      JSIL.MethodSignature.Return($asm0E.TypeRef("System.Collections.Generic.IEnumerator`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Face")])), 
      $lGetAllFaces$gd__35_System_Collections_Generic_IEnumerable$lFusee_Jometri_DCEL_Face$g_GetEnumerator
    )
      .Overrides($asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Face")]), "GetEnumerator")
      .Attribute($asm0E.TypeRef("System.Diagnostics.DebuggerHiddenAttribute"));
    ...
    $.Method({Static:false, Public:false, Virtual:true }, "System.Collections.Generic.IEnumerator$lFusee.Jometri.DCEL.Face$g.get_Current", 
      ...
      .Overrides($asm0E.TypeRef("System.Collections.Generic.IEnumerator`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Face")]), "get_Current")
      .Attribute($asm0E.TypeRef("System.Diagnostics.DebuggerHiddenAttribute"));
    ...
    $.Field({Static:false, Public:false}, "$l$gs__1", $asm0E.TypeRef("System.Collections.Generic.Dictionary`2+Enumerator", [$.Int32, $asm06.TypeRef("Fusee.Jometri.DCEL.Face")]));

    $.Field({Static:false, Public:false}, "$lface$g5__2", $asm0E.TypeRef("System.Collections.Generic.KeyValuePair`2", [$.Int32, $asm06.TypeRef("Fusee.Jometri.DCEL.Face")]));
    ...
    $.ImplementInterfaces(
      /* 0 */ $asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Face")]), 
      /* 1 */ $asm0E.TypeRef("System.Collections.IEnumerable"), 
      /* 2 */ $asm0E.TypeRef("System.Collections.Generic.IEnumerator`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.Face")]), 
      /* 3 */ $asm0E.TypeRef("System.Collections.IEnumerator"), 
      /* 4 */ $asm0E.TypeRef("System.IDisposable")
    );
...
(function $l$gc__DisplayClass59_0$Members () {
  ...
  var $T03 = function () {
    return ($T03 = JSIL.Memoize($asm0E.System.Func$b2.Of($asm06.Fusee.Jometri.DCEL.HalfEdge, $asm0E.System.Boolean))) ();
  };
  var $T04 = function () {
    return ($T04 = JSIL.Memoize($asm06.Fusee.Jometri.DCEL.Geometry_$l$gc__DisplayClass59_2)) ();
  };
  var $S00 = function () {
  ...
  var $S01 = function () {
    return ($S01 = JSIL.Memoize(new JSIL.MethodSignature($asm0E.System.Boolean, [$asm06.Fusee.Jometri.DCEL.HalfEdge]))) ();
  };
  var $S02 = function () {
    return ($S02 = JSIL.Memoize(new JSIL.MethodSignature($asm0E.System.Boolean, [$asm06.Fusee.Jometri.DCEL.HalfEdge]))) ();
  };
  ...
  function $l$gc__DisplayClass59_0_$lGetFaceToInsertDiag$gb__0 (x) {
    ...
    return $S00().CallStatic($T02(), "Any$b1", [$asm06.Fusee.Jometri.DCEL.HalfEdge], this.heStartingAtP, $T03().New($closure0, null, new JSIL.MethodPointerInfo($asm06.Fusee.Jometri.DCEL.Geometry_$l$gc__DisplayClass59_1, "$lGetFaceToInsertDiag$gb__1", $S01(), false, false)));
  }; 

  function $l$gc__DisplayClass59_0_$lGetFaceToInsertDiag$gb__2 (x) {
    var $closure0 = new ($T04())();
    $closure0.x = x.MemberwiseClone();
    return $S00().CallStatic($T02(), "Any$b1", [$asm06.Fusee.Jometri.DCEL.HalfEdge], this.heStartingAtQ, $T03().New($closure0, null, new JSIL.MethodPointerInfo($asm06.Fusee.Jometri.DCEL.Geometry_$l$gc__DisplayClass59_2, "$lGetFaceToInsertDiag$gb__3", $S02(), false, false)));
  }; 
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:true }, "heStartingAtP", $asm0E.TypeRef("System.Collections.Generic.List`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")]));

    $.Field({Static:false, Public:true }, "heStartingAtQ", $asm0E.TypeRef("System.Collections.Generic.List`1", [$asm06.TypeRef("Fusee.Jometri.DCEL.HalfEdge")]));
