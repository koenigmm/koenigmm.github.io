...
(function AssetStorage$Members () {
  ...
  var $S00 = function () {
    return ($S00 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.TypeRef("System.Collections.Generic.List`1", [$asm00.TypeRef("Fusee.Base.Common.IAssetProvider")]), null))) ();
  };
  var $S01 = function () {
  ...
  var $S04 = function () {
    return ($S04 = JSIL.Memoize(new JSIL.MethodSignature($asm0E.TypeRef("System.Object"), [
...
(function Font$Members () {
  ...
  var $T01 = function () {
    return ($T01 = JSIL.Memoize($asm0E.System.Collections.Generic.Dictionary$b2.Of($asm0E.System.UInt32, $asm07.Fusee.Math.Core.Curve))) ();
  };
  var $T02 = function () {
  ...
  var $S00 = function () {
    return ($S00 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.TypeRef("System.Collections.Generic.Dictionary`2", [$asm0E.TypeRef("System.UInt32"), $asm00.TypeRef("Fusee.Base.Common.GlyphInfo")]), null))) ();
  };
  var $S01 = function () {
    return ($S01 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.TypeRef("System.Collections.Generic.Dictionary`2", [$asm0E.TypeRef("System.UInt32"), $asm07.TypeRef("Fusee.Math.Core.Curve")]), null))) ();
  };
  var $S02 = function () {
    return ($S02 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.TypeRef("System.Collections.Generic.Dictionary`2", [$asm0E.TypeRef("System.UInt32"), $asm0E.TypeRef("System.Single")]), null))) ();
  };
  var $IM00 = function () {
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:false, ReadOnly:true }, "_glyphCurveChache", $asm0E.TypeRef("System.Collections.Generic.Dictionary`2", [$.UInt32, $asm07.TypeRef("Fusee.Math.Core.Curve")]));
