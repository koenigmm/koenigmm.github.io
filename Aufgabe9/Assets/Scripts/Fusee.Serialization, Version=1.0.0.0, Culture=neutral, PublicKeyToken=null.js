...
(function SceneComponentContainer$Members () {
  ...
  JSIL.MakeType({
    ...
    .Attribute($asm0F.TypeRef("ProtoBuf.ProtoIncludeAttribute"), function () { return [108, $asm08.Fusee.Serialization.RectTransformComponent.__Type__]; });
...
(function AnimationComponent$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:true }, "AnimationTracks", $asm0E.TypeRef("System.Collections.Generic.List`1", [$asm08.TypeRef("Fusee.Serialization.AnimationTrackContainer")]))
      .Attribute($asm0F.TypeRef("ProtoBuf.ProtoMemberAttribute"), function () { return [3]; });
...
(function AnimationTrackContainer$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:true }, "KeyFrames", $asm0E.TypeRef("System.Collections.Generic.List`1", [$asm08.TypeRef("Fusee.Serialization.AnimationKeyContainerBase")]))
      .Attribute($asm0F.TypeRef("ProtoBuf.ProtoMemberAttribute"), function () { return [4]; });
...
(function SceneContainer$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:true }, "Children", $asm0E.TypeRef("System.Collections.Generic.List`1", [$asm08.TypeRef("Fusee.Serialization.SceneNodeContainer")]))
      .Attribute($asm0F.TypeRef("ProtoBuf.ProtoMemberAttribute"), function () { return [2]; });
...
(function SceneNodeContainer$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:true }, "Components", $asm0E.TypeRef("System.Collections.Generic.List`1", [$asm08.TypeRef("Fusee.Serialization.SceneComponentContainer")]))
      .Attribute($asm0F.TypeRef("ProtoBuf.ProtoMemberAttribute"), function () { return [2]; });
    ...
    .Attribute($asm0F.TypeRef("ProtoBuf.ProtoContractAttribute"))
    .Attribute($asm0E.TypeRef("System.Diagnostics.DebuggerDisplayAttribute"), function () { return ["{Name,nq}, {(Components==null)? \"No\" : Components.Count.ToString(),nq} components, {(Children==null)? \"No\" : Children.Count.ToString(),nq} children"]; });
...
(function ShaderComponent$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:true }, "EffectPasses", $asm0E.TypeRef("System.Collections.Generic.List`1", [$asm08.TypeRef("Fusee.Serialization.RenderPass")]))
      .Attribute($asm0F.TypeRef("ProtoBuf.ProtoMemberAttribute"), function () { return [1]; });

    $.Field({Static:false, Public:true }, "EffectParameter", $asm0E.TypeRef("System.Collections.Generic.List`1", [$asm08.TypeRef("Fusee.Serialization.TypeContainer")]))
      .Attribute($asm0F.TypeRef("ProtoBuf.ProtoMemberAttribute"), function () { return [2]; });
...
(function RectTransformComponent$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:true }, "Anchors", $asm07.TypeRef("Fusee.Math.Core.MinMaxRect"))
      .Attribute($asm0F.TypeRef("ProtoBuf.ProtoMemberAttribute"), function () { return [1]; });

    $.Field({Static:false, Public:true }, "Offsets", $asm07.TypeRef("Fusee.Math.Core.MinMaxRect"))
      .Attribute($asm0F.TypeRef("ProtoBuf.ProtoMemberAttribute"), function () { return [2]; });
...
(function TypeContainer$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:true }, "KeyType", $asm0E.TypeRef("System.Type"))
      .Attribute($asm0F.TypeRef("ProtoBuf.ProtoMemberAttribute"), function () { return [2]; });
...
(function WeightComponent$Members () {
  ...
  JSIL.MakeType({
    ...
    $.Field({Static:false, Public:true }, "WeightMap", $asm0E.TypeRef("System.Collections.Generic.List`1", [$asm08.TypeRef("Fusee.Serialization.VertexWeightList")]))
      .Attribute($asm0F.TypeRef("ProtoBuf.ProtoMemberAttribute"), function () { return [1]; });

    $.Field({Static:false, Public:true }, "Joints", $asm0E.TypeRef("System.Collections.Generic.List`1", [$asm08.TypeRef("Fusee.Serialization.SceneNodeContainer")]))
      .Attribute($asm0F.TypeRef("ProtoBuf.ProtoMemberAttribute"), function () { return [2]; });

    $.Field({Static:false, Public:true }, "BindingMatrices", $asm0E.TypeRef("System.Collections.Generic.List`1", [$asm07.TypeRef("Fusee.Math.Core.float4x4")]))
      .Attribute($asm0F.TypeRef("ProtoBuf.ProtoMemberAttribute"), function () { return [3]; });
...
(function VertexWeightList$Members () {
  var $, $thisType;
  var $T00 = function () {
    return ($T00 = JSIL.Memoize($asm0E.System.Collections.Generic.List$b1.Of($asm08.Fusee.Serialization.VertexWeight))) ();
  };
  ...
  JSIL.MakeType({
    ...
    $.Method({Static:false, Public:true }, "get_VertexWeights", 
      JSIL.MethodSignature.Return($asm0E.TypeRef("System.Collections.Generic.List`1", [$asm08.TypeRef("Fusee.Serialization.VertexWeight")])), 
    ...
    $.Method({Static:false, Public:true }, "set_VertexWeights", 
      JSIL.MethodSignature.Action($asm0E.TypeRef("System.Collections.Generic.List`1", [$asm08.TypeRef("Fusee.Serialization.VertexWeight")])), 
      VertexWeightList_set_VertexWeights
    )
      .Attribute($asm0E.TypeRef("System.Runtime.CompilerServices.CompilerGeneratedAttribute"));

    $.Field({Static:false, Public:false}, "VertexWeightList$VertexWeights$value", $asm0E.TypeRef("System.Collections.Generic.List`1", [$asm08.TypeRef("Fusee.Serialization.VertexWeight")]))
      .Attribute($asm0E.TypeRef("System.Runtime.CompilerServices.CompilerGeneratedAttribute"))
    ...
    $.Property({Static:false, Public:true }, "VertexWeights", $asm0E.TypeRef("System.Collections.Generic.List`1", [$asm08.TypeRef("Fusee.Serialization.VertexWeight")]))
      .Attribute($asm0F.TypeRef("ProtoBuf.ProtoMemberAttribute"), function () { return [1]; });
