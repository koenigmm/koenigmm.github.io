...
(function Tutorial$Members () {
  ...
  var $T0A = function () {
    return ($T0A = JSIL.Memoize($asm0A.Fusee.Tutorial.Core.HierarchyInput)) ();
  };
  var $T0B = function () {
  ...
  function Tutorial_Main () {
    ...
    var hierarchyInput = new ($T0A())();
    hierarchyInput.RenderCanvas$CanvasImplementor$value = new ($T0C())();
    hierarchyInput.RenderCanvas$ContextImplementor$value = new ($T0D())(hierarchyInput.RenderCanvas$CanvasImplementor$value);
    $T0E().AddDriverImp(new ($T0F())(hierarchyInput.RenderCanvas$CanvasImplementor$value));
    hierarchyInput.Run();
  }; 
