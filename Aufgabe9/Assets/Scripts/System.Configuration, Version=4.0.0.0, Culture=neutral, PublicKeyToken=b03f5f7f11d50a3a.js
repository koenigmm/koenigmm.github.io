...
(function FipsAwareEncryptedXml$Members () {
  ...
  JSIL.MakeType({
    ...
    $.ExternalMethod({Static:false, Public:true , Virtual:true }, "GetDecryptionKey", 
      new JSIL.MethodSignature($asm0E.TypeRef("System.Security.Cryptography.SymmetricAlgorithm"), [$asm15.TypeRef("System.Security.Cryptography.Xml.EncryptedData"), $.String])
    );
