...
(function Mesh$Members () {
  ...
  var $T12 = function () {
    return ($T12 = JSIL.Memoize($asm0E.System.Math)) ();
  };
  var $T13 = function () {
    return ($T13 = JSIL.Memoize($asm0E.System.Double)) ();
  };
  var $T14 = function () {
    return ($T14 = JSIL.Memoize($asm0E.System.Single)) ();
  };
  var $S00 = function () {
  ...
  var $S06 = function () {
    return ($S06 = JSIL.Memoize(new JSIL.ConstructorSignature($asm04.Fusee.Engine.Core.SceneRenderer, [$asm08.Fusee.Serialization.SceneContainer]))) ();
  };
  var $S07 = function () {
    return ($S07 = JSIL.Memoize(new JSIL.MethodSignature($asm0E.System.Single, [$asm0E.System.Single]))) ();
  };
  var $S08 = function () {
    return ($S08 = JSIL.Memoize(new JSIL.MethodSignature($asm07.Fusee.Math.Core.float4x4, [$asm07.Fusee.Math.Core.float4x4, $asm07.Fusee.Math.Core.float4x4]))) ();
  };
  ...
  function Mesh_CreateScene () {
    ...
    var expr_84 = new ($T07())();
    var expr_8A = new ($T08())();
    expr_8A.Color = $S00().Construct(1, 0.2, 0.2);
    ...
    $S03().CallVirtual("Add", null, expr_71, $T0A().CreateCylinder(10, 10, 10));
...
(function SimpleMeshes$Members () {
  ...
  function SimpleMeshes_CreateCylinder (radius, height, segments) {
    ...
    var tris = JSIL.Array.New($T05(), Math.imul(Math.imul(4, segments), 3));
    ...
    verts[Math.imul(4, segments)] = $S01().Construct(radius, (0.5 * +height), 0);
    norms[Math.imul(4, segments)] = $T03().UnitY.MemberwiseClone();
    verts[((Math.imul(4, segments) + 1) | 0)] = $S01().Construct(radius, (-0.5 * +height), 0);
    ...
    var expr_3E6 = new ($T04())();
    expr_3E6.Vertices = verts;
    expr_3E6.Normals = norms;
    expr_3E6.Triangles = tris;
    return expr_3E6;
  }; 
