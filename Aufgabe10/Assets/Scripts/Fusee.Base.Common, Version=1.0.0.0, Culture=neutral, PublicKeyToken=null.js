...
(function ColorUint$Members () {
  ...
  var $S09 = function () {
    return ($S09 = JSIL.Memoize(new JSIL.ConstructorSignature($asm07.Fusee.Math.Core.float4, [
        $asm0E.System.Single, $asm0E.System.Single, 
        $asm0E.System.Single, $asm0E.System.Single
      ]))) ();
  };
  ...
  JSIL.MakeType({
    ...
    $.Method({Static:false, Public:true }, "Tofloat3", 
      ...
      .Attribute($asm0E.TypeRef("System.ObsoleteAttribute"), function () { return ["Deprecated due to 'Impure Method Call Warning' and problems with JSIL. Use 'static float3 Tofloat3(ColorUint col)' instead!"]; });
    ...
    $.Method({Static:false, Public:true }, "Tofloat4", 
      ...
      .Attribute($asm0E.TypeRef("System.ObsoleteAttribute"), function () { return ["Deprecated due to 'Impure Method Call Warning' and problems with JSIL. Use 'static float3 Tofloat4(ColorUint col)' instead!"]; });
...
(function ExtensionMethods$Members () {
  ...
  function ExtensionMethods_LastItem$b1 (T, data) {
    ...
    for (var iEnum = $im00.Call(data, null); $IM00().Call(iEnum, null); ) {
      temp = JSIL.CloneParameter(T, $im01.Call(iEnum, null));
    }
    return temp;
  }; 
  ...
  function ExtensionMethods_SequEqual$b1 (T, source, compObj) {
    var $im00 = $asm0E.System.Collections.Generic.IEnumerable$b1.Of(T).GetEnumerator;
    var $im01 = $asm0E.System.Collections.Generic.IEnumerator$b1.Of(T).get_Current;
    var $enum = $im00.Call(source, null);
    var enum2 = $im00.Call(compObj, null);
    var count = 0;
    var count2 = 0;

    while ($IM00().Call($enum, null)) {
      count = ((count + 1) | 0);
    }
    $IM01().Call($enum, null);

    while ($IM00().Call(enum2, null)) {
      count2 = ((count2 + 1) | 0);
    }
    $IM01().Call(enum2, null);
    var flag = count !== count2;
    if (flag) {
      var result = false;
    } else {

      while ($IM00().Call($enum, null) && $IM00().Call(enum2, null)) {
        var current = JSIL.CloneParameter(T, $im01.Call($enum, null));
        var flag2 = !(JSIL.ObjectEqualsInstance(current, $im01.Call(enum2, null), !false, $T04().__Type__));
        if (flag2) {
          result = false;
          return result;
        }
  ...
  function ExtensionMethods_SkipItems$b1 (T, data, count) {
    ...
    var $im00 = $asm0E.System.Collections.Generic.IEnumerable$b1.Of(T).GetEnumerator;
    var $im01 = $asm0E.System.Collections.Generic.IEnumerator$b1.Of(T).get_Current;
    var zwerg = $s00.Construct();
    $asm0E.System.Collections.Generic.List$b1.Of(T).prototype.AddRange.call(zwerg, $asm0E.System.Collections.Generic.List$b1.Of(T).$Cast(data));
    var i = 0;
    ...
    $loop0: 
      while ($IM00().Call(enumerator, null)) {
        var t = $im01.Call(enumerator, null);
        var flag = i < (count | 0);
        if (!flag) {
          break $loop0;
        }
  ...
  function ExtensionMethods_TakeItems$b1 (T, data, count) {
    ...
    $loop0: 
      while ($IM00().Call(enumerator, null)) {
        ...
        $s01.CallVirtual("Add", null, items, JSIL.CloneParameter(T, t));
        i = ((i + 1) | 0);
      }
    } finally {
      if (enumerator !== null) {
...
(function SplitToCurveSegmentHelper$Members () {
  ...
  var $S03 = function () {
    return ($S03 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.List$b1.Of($asm07.Fusee.Math.Core.float3), [$asm0E.TypeRef("System.Collections.Generic.IEnumerable`1", [$asm07.TypeRef("Fusee.Math.Core.float3")])]))) ();
  };
  var $S04 = function () {
  ...
  var $S06 = function () {
    return ($S06 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.List$b1.Of($asm07.Fusee.Math.Core.CurveSegment), null))) ();
  };
  var $S07 = function () {
    return ($S07 = JSIL.Memoize(new JSIL.MethodSignature(null, [$asm07.TypeRef("Fusee.Math.Core.CurveSegment")]))) ();
  };
  var $S08 = function () {
    return ($S08 = JSIL.Memoize(new JSIL.ConstructorSignature($asm0E.System.Collections.Generic.List$b1.Of($asm0E.System.Byte), null))) ();
  };
  var $S09 = function () {
  ...
  function SplitToCurveSegmentHelper_CreateCurveSegment$00 (i, pattern, verts) {
    ...
    $T0C().prototype.AddRange.call(segmentVerts, $T0D().TakeItems$b1($T07())(
  ...
  function SplitToCurveSegmentHelper_CreateOnPointsAndAddToList (vertices) {
    ...
    zeroes.Remove($S04().CallStatic($T13(), "First$b1", [$asm07.Fusee.Math.Core.float3], zeroes).MemberwiseClone());
    zeroes.Remove($T0D().LastItem$b1($T07())(zeroes).MemberwiseClone());
  ...
  function SplitToCurveSegmentHelper_FixSegments (segments) {
    var firstPoint = $S04().CallStatic($T13(), "First$b1", [$asm07.Fusee.Math.Core.float3], $S05().CallStatic($T13(), "First$b1", [$asm07.Fusee.Math.Core.CurveSegment], segments).Vertices).MemberwiseClone();
    var enumerator = $IM08().Call(segments, null);
    try {

      while ($IM01().Call(enumerator, null)) {
        var seg = $IM09().Call(enumerator, null);
        $IM0A().Call(seg.Vertices, null, $S04().CallStatic($T13(), "First$b1", [$asm07.Fusee.Math.Core.float3], seg.Vertices).MemberwiseClone());
      }
    } finally {
      if (enumerator !== null) {
        $IM05().Call(enumerator, null);
    ...
    var flag = $T07().op_Equality(firstPoint.MemberwiseClone(), $T0D().LastItem$b1($T07())($T0D().LastItem$b1($T0F())(segments).Vertices).MemberwiseClone());
    if (!flag) {
      var expr_74 = new ($T0E())();
  ...
  function SplitToCurveSegmentHelper_SplitPartIntoSegments (part, partTags, partVerts) {
    var linearPattern = JSIL.Array.New($T1A(), [1, 1]);
    var conicPattern = JSIL.Array.New($T1A(), [1, 0, 1]);
    var cubicPattern = JSIL.Array.New($T1A(), [1, 0, 0, 1]);
    var expr_34 = JSIL.Array.New($T1A(), 4);
    expr_34[0] = 1;
    var segments = $S06().Construct();

    for (var i = 0; i < (partTags.get_Count() | 0); i = ((i + 1) | 0)) {
      var flag = $T0D().SequEqual$b1($T1A())($T0D().TakeItems$b1($T1A())($T0D().SkipItems$b1($T1A())(partTags, i), linearPattern.length), $T1B().$Cast(linearPattern));
      if (flag) {
        $thisType.SplitToCurveSegmentHelper$Type$value = $T17().LINEAR;
        $S07().CallVirtual("Add", null, segments, $thisType.CreateCurveSegment(i, $T0B().$Cast(linearPattern), partVerts));
      } else {
        var flag2 = $T0D().SequEqual$b1($T1A())($T0D().TakeItems$b1($T1A())($T0D().SkipItems$b1($T1A())(partTags, i), conicPattern.length), $T1B().$Cast(conicPattern));
        if (flag2) {
          $thisType.SplitToCurveSegmentHelper$Type$value = $T17().CONIC;
          $S07().CallVirtual("Add", null, segments, $thisType.CreateCurveSegment(i, $T0B().$Cast(conicPattern), partVerts));
          i = ((i + 1) | 0);
        } else {
          var flag3 = $T0D().SequEqual$b1($T1A())($T0D().TakeItems$b1($T1A())($T0D().SkipItems$b1($T1A())(partTags, i), cubicPattern.length), $T1B().$Cast(cubicPattern));
          if (flag3) {
            $thisType.SplitToCurveSegmentHelper$Type$value = $T17().CUBIC;
            $S07().CallVirtual("Add", null, segments, $thisType.CreateCurveSegment(i, $T0B().$Cast(cubicPattern), partVerts));
            i = ((i + 2) | 0);
          } else {
            ...
            $loop1: 
              ...
              $S07().CallVirtual("Add", null, segments, cs);
            } else {
              var lastSegment = $S08().Construct();
              $T18().prototype.AddRange.call(lastSegment, $T0D().TakeItems$b1($T1A())(
                  $T0D().SkipItems$b1($T1A())(partTags, i), 
                  (((partTags.get_Count() | 0) - i) | 0)
                ));
              $S09().CallVirtual("Add", null, lastSegment, partTags.get_Item(0));
              var flag7 = $T0D().SequEqual$b1($T1A())(lastSegment, $T1B().$Cast(conicPattern));
              if (flag7) {
                $S07().CallVirtual("Add", null, segments, $thisType.CreateCurveSegment(i, $T0B().$Cast(conicPattern), partVerts.get_Item(0).MemberwiseClone(), partVerts));
              } else {
                var flag8 = $T0D().SequEqual$b1($T1A())(lastSegment, $T1B().$Cast(cubicPattern));
                if (flag8) {
                  $S07().CallVirtual("Add", null, segments, $thisType.CreateCurveSegment(i, $T0B().$Cast(cubicPattern), partVerts.get_Item(0).MemberwiseClone(), partVerts));
                } else {
                  var flag9 = $T0D().SequEqual$b1($T1A())(lastSegment, $T1B().$Cast(expr_34));
                  if (flag9) {
                    $S07().CallVirtual("Add", null, segments, $thisType.CreateCurveSegment(i, $T0B().$Cast(cubicPattern), partVerts.get_Item(0).MemberwiseClone(), partVerts));
                  }
                }
